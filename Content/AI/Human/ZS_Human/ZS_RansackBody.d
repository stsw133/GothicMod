...
func void ZS_RansackBody_End()
{
	...
	{
		var int x;	x = Npc_HasItems(other,ItMi_Gold);
	...
	{
		AI_StartState (self, ZS_HealSelf, false, "");	/// wird aus ZS_Attack NACH ZS_RansackBody aufgerufen, kommt also dort nicht mehr zum Zuge und wird daher hier auch aufgerufen
		return;
	};
};
...
func void ZS_GetMeat()
{
	...
	AI_PlayAni (self, "T_PLUNDER");
	var int x; x = Npc_HasItems(other,ItFoMuttonRaw);
