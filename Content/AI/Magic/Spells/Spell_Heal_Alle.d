...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_PalLightHeal/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_PalMediumHeal/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_PalFullHeal/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_LightHeal/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_MediumHeal/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_FullHeal/SPL_Cost_Scroll))
...
func void Spell_Cast_Heal()
{
	if (Npc_GetActiveSpell(self) == SPL_LightHeal)
	{
		...
		{
			self.attribute[ATR_MANA] -= SPL_Cost_LightHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_LightHeal;
	...
	if (Npc_GetActiveSpell(self) == SPL_MediumHeal)	
	{
		if (Npc_GetActiveSpellIsScroll(self))
		{
			self.attribute[ATR_MANA] -= SPL_Cost_MediumHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_MediumHeal;
	...
	if (Npc_GetActiveSpell(self) == SPL_FullHeal)
	{
		if (Npc_GetActiveSpellIsScroll(self))
		{
			self.attribute[ATR_MANA] -= SPL_Cost_FullHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_FullHeal;
...
func void Spell_Cast_PalHeal()
{
	if (Npc_GetActiveSpell(self) == SPL_PalLightHeal)
	{
		if (Npc_GetActiveSpellIsScroll(self))
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalLightHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalLightHeal;
	...
	if (Npc_GetActiveSpell(self) == SPL_PalMediumHeal)
	{
		if (Npc_GetActiveSpellIsScroll(self))
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalMediumHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalMediumHeal;
	...
	if (Npc_GetActiveSpell(self) == SPL_PalFullHeal)
	{
		if (Npc_GetActiveSpellIsScroll(self))
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalFullHeal/SPL_Cost_Scroll;
		}
		else
		{
			self.attribute[ATR_MANA] -= SPL_Cost_PalFullHeal;
