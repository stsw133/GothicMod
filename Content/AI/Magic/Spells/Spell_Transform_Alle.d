...
///******************************************************************************************
instance Spell_Transform2 (C_Spell_Proto)
{
	time_per_mana						=	0;
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfSheep/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfScavenger/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfGiantRat/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfGiantBug/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfWolf/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfWaran/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfSnapper/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfWarg/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfFireWaran/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfLurker/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfShadowbeast/SPL_Cost_Scroll))
...
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfDragonSnapper/SPL_Cost_Scroll))
