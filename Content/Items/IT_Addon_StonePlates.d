...
func void Use_StonePlate ()
{
	...
	else //(C_SCHasStPlSkill() == TRUE)
	{
		...
		else if (StoneplateItem == OneHStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_AddFightSkill (self, NPC_TALENT_1H, OneH_StPlLevel1);
						...
						{
							B_AddFightSkill (self, NPC_TALENT_1H, OneH_StPlLevel2);
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_1H, OneH_StPlLevel3);
							concatText = ConcatStrings (concatText,	" + ");
		...
		else if (StoneplateItem == TwoHStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_AddFightSkill (self, NPC_TALENT_2H, TwoH_StPlLevel1);
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_2H, TwoH_StPlLevel2);
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_2H, TwoH_StPlLevel3);
							concatText = ConcatStrings (concatText,	" + ");
		...
		else if (StoneplateItem == BowStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_AddFightSkill (self, NPC_TALENT_BOW, Bow_StPlLevel1);			//Bogen steigern
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_BOW, Bow_StPlLevel2);			//Bogen steigern
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_BOW, Bow_StPlLevel3);			//Bogen steigern
							concatText = ConcatStrings (concatText,	" + ");
		...
		else if (StoneplateItem == CrsBowStonePlate)
		{
						...
						if 		(StoneplateLevel == 1)
						{
							B_AddFightSkill (self, NPC_TALENT_CROSSBOW, CrsBow_StPlLevel1);	//Crossbow mit hochziehen
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_CROSSBOW, CrsBow_StPlLevel2);	//Crossbow mit hochziehen
							concatText = ConcatStrings (concatText,	" + ");
						...
						{
							B_AddFightSkill (self, NPC_TALENT_CROSSBOW, CrsBow_StPlLevel3);	//Crossbow mit hochziehen
							concatText = ConcatStrings (concatText,	" + ");
