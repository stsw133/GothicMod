...
///******************************************************************************************
instance ItAm_Armor_01 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Edge_01.3ds";
	description		=	"Amulet pancerza I";
	SetItAmAttributes_Armor (self, 1);
};
...
///******************************************************************************************
instance ItAm_Resist_01 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Mage_01.3ds";
	description		=	"Amulet odpornoœci I";
	SetItAmAttributes_Resist (self, 1);
};
...
{
	visual 			=	"ItAm_Prot_Mage_01.3ds";
	description		=	"Amulet odpornoœci V";
...
///******************************************************************************************
instance ItAm_TrueDamage_01 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Point_01.3ds";
	description		=	"Amulet obra¿eñ I";
	SetItAmAttributes_TrueDamage (self, 1);
	on_equip		=	Equip_ItAm_TrueDamage_01;
	on_unequip		=	UnEquip_ItAm_TrueDamage_01;
};
func void Equip_ItAm_TrueDamage_01()	{ self.aivar[AIV_TrueDamage] += 4; };
func void UnEquip_ItAm_TrueDamage_01()	{ self.aivar[AIV_TrueDamage] -= 4; };

instance ItAm_TrueDamage_02 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Point_01.3ds";
	description		=	"Amulet obra¿eñ II";
	SetItAmAttributes_TrueDamage (self, 2);
	on_equip		=	Equip_ItAm_TrueDamage_02;
	on_unequip		=	UnEquip_ItAm_TrueDamage_02;
};
func void Equip_ItAm_TrueDamage_02()	{ self.aivar[AIV_TrueDamage] += 8; };
func void UnEquip_ItAm_TrueDamage_02()	{ self.aivar[AIV_TrueDamage] -= 8; };

instance ItAm_TrueDamage_03 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Point_01.3ds";
	description		=	"Amulet obra¿eñ III";
	SetItAmAttributes_TrueDamage (self, 3);
	on_equip		=	Equip_ItAm_TrueDamage_03;
	on_unequip		=	UnEquip_ItAm_TrueDamage_03;
};
func void Equip_ItAm_TrueDamage_03()	{ self.aivar[AIV_TrueDamage] += 12; };
func void UnEquip_ItAm_TrueDamage_03()	{ self.aivar[AIV_TrueDamage] -= 12; };

instance ItAm_TrueDamage_04 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Point_01.3ds";
	description		=	"Amulet obra¿eñ IV";
	SetItAmAttributes_TrueDamage (self, 4);
	on_equip		=	Equip_ItAm_TrueDamage_04;
	on_unequip		=	UnEquip_ItAm_TrueDamage_04;
};
func void Equip_ItAm_TrueDamage_04()	{ self.aivar[AIV_TrueDamage] += 16; };
func void UnEquip_ItAm_TrueDamage_04()	{ self.aivar[AIV_TrueDamage] -= 16; };

instance ItAm_TrueDamage_05 (ItemPR_Amulet)
{
	visual 			=	"ItAm_Prot_Point_01.3ds";
	description		=	"Amulet obra¿eñ V";
	SetItAmAttributes_TrueDamage (self, 5);
	on_equip		=	Equip_ItAm_TrueDamage_05;
	on_unequip		=	UnEquip_ItAm_TrueDamage_05;
};
func void Equip_ItAm_TrueDamage_05()	{ self.aivar[AIV_TrueDamage] += 20; };
func void UnEquip_ItAm_TrueDamage_05()	{ self.aivar[AIV_TrueDamage] -= 20; };
...
func void Equip_ItAm_LifeSteal_01()		{ self.aivar[AIV_LifeSteal] += 2; };
func void UnEquip_ItAm_LifeSteal_01()	{ self.aivar[AIV_LifeSteal] -= 2; };
...
func void Equip_ItAm_LifeSteal_02()		{ self.aivar[AIV_LifeSteal] += 4; };
func void UnEquip_ItAm_LifeSteal_02()	{ self.aivar[AIV_LifeSteal] -= 4; };
...
func void Equip_ItAm_LifeSteal_03()		{ self.aivar[AIV_LifeSteal] += 6; };
func void UnEquip_ItAm_LifeSteal_03()	{ self.aivar[AIV_LifeSteal] -= 6; };
...
func void Equip_ItAm_LifeSteal_04()		{ self.aivar[AIV_LifeSteal] += 8; };
func void UnEquip_ItAm_LifeSteal_04()	{ self.aivar[AIV_LifeSteal] -= 8; };
...
func void Equip_ItAm_LifeSteal_05()		{ self.aivar[AIV_LifeSteal] += 10; };
func void UnEquip_ItAm_LifeSteal_05()	{ self.aivar[AIV_LifeSteal] -= 10; };
...
///******************************************************************************************
instance ItAm_OrcArchshaman (ItemPR_Amulet)
{
	name 			=	"Amulet orkowych arcyszamanów";
	flags 			=	ITEM_AMULET|ITEM_MISSION;
