...
///******************************************************************************************
func void SetItArAttributes (var C_ITEM itm, var int value, var int ar, var int pr, var int fr, var int mr, var int skin)
{
//	itm.cond_value[2]  			=	kap;
	
	itm.value 					=	value*50;	//kap*50
	
	itm.protection[PROT_EDGE]	=	ar;	//kap*AR_PER_LEVEL
	itm.protection[PROT_BLUNT]	= 	ar;	//kap*AR_PER_LEVEL
	itm.protection[PROT_POINT]	= 	pr;	//kap*AR_PER_LEVEL
...
instance ITAR_STT_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 4,   20,20,0,0,   0);
};
instance ITAR_STT_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 6,   30,30,0,0,   0);
};
instance ITAR_GRD_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 12,   50,50,10,10,   0);
};
instance ITAR_GRD_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 18,   70,70,20,20,   0);
};
instance ITAR_GRD_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 24,   90,90,30,30,   0);
};
instance ITAR_EBR_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 40,   120,120,80,80,   0);
...
instance ITAR_EBR_G (ItemPR_Armor)
{
	...
	visual 			=	"ITAR_CHAOS_ADDON.3ds";
	visual_change 	=	"Armor_EBR.asc";
	SetItArAttributes (self, 45,   135,135,90,90,   1);
...
instance ITAR_SLN_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 1,   5,5,0,0,   0);
};
instance ITAR_SLN_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 5,   20,20,0,10,   0);
};
instance ITAR_SLN_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 6,   25,25,0,10,   0);
};
...
instance ITAR_SLG_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 12,   40,40,20,20,   0);
};
instance ITAR_SLG_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 18,   60,60,30,30,   0);
};
///******************************************************************************************
instance ITAR_ORE_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 50,   150,150,100,100,   0);
...
instance ITAR_ORE_H (ItemPR_Armor)
{
	...
	visual 			=	"ItAr_Chaos_Addon.3ds";
	visual_change 	=	"Armor_ORE.asc";
	SetItArAttributes (self, 60,   180,180,120,120,   1);
