...
instance ITAR_VLK_L_03 (ItemPR_Armor)	///vlk green-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   3);	/// 2 level
};
instance ITAR_VLK_L_04 (ItemPR_Armor)	///vlk red-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   4);	/// 2 level
};
instance ITAR_VLK_L_05 (ItemPR_Armor)	///vlk black
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   5);	/// 2 level
};
instance ITAR_VLK_L_06 (ItemPR_Armor)	///vlk white
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   6);	/// 2 level
};
instance ITAR_VLK_L_07 (ItemPR_Armor)	///vlk blue
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   7);	/// 2 level
};
instance ITAR_VLK_L_08 (ItemPR_Armor)	///vlk green
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   8);	/// 2 level
};
instance ITAR_VLK_L_09 (ItemPR_Armor)	///vlk dark
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   9);	/// 2 level
};
instance ITAR_VLK_L_10 (ItemPR_Armor)	///vlk green-white
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   10);	/// 2 level
};
instance ITAR_VLK_L_11 (ItemPR_Armor)	///vlk orange
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   11);	/// 2 level
};
instance ITAR_VLK_L_12 (ItemPR_Armor)	///vlk yellow
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   12);	/// 2 level
};
instance ITAR_VLK_L_13 (ItemPR_Armor)	///vlk white
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   13);	/// 2 level
};
instance ITAR_VLK_L_14 (ItemPR_Armor)	///vlk dark-green
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   14);	/// 2 level
};
instance ITAR_VLK_L_15 (ItemPR_Armor)	///vlk brown-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_L.asc";
	SetItArAttributes (self, 10,0,0,   15);	/// 2 level
};
///******************************************************************************************
instance ITAR_VLK_H_00 (ItemPR_Armor)	///vlk harbor-district
{
	...
	SetItArAttributes (self, 15,0,0,   0);	/// 3 level
};
instance ITAR_VLK_H_01 (ItemPR_Armor)	///vlk casual
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   1);	/// 3 level
};
instance ITAR_VLK_H_02 (ItemPR_Armor)	///vlk rich
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   2);	/// 3 level
};
instance ITAR_VLK_H_03 (ItemPR_Armor)	///vlk green-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   3);	/// 3 level
};
instance ITAR_VLK_H_04 (ItemPR_Armor)	///vlk red-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   4);	/// 3 level
};
instance ITAR_VLK_H_05 (ItemPR_Armor)	///vlk black
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   5);	/// 3 level
};
instance ITAR_VLK_H_06 (ItemPR_Armor)	///vlk white
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   6);	/// 3 level
};
instance ITAR_VLK_H_07 (ItemPR_Armor)	///vlk blue
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   7);	/// 3 level
};
instance ITAR_VLK_H_08 (ItemPR_Armor)	///vlk green
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   8);	/// 3 level
};
instance ITAR_VLK_H_09 (ItemPR_Armor)	///vlk dark
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   9);	/// 3 level
};
instance ITAR_VLK_H_10 (ItemPR_Armor)	///vlk green-white
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self,15,0,0,   10);	/// 3 level
};
instance ITAR_VLK_H_11 (ItemPR_Armor)	///vlk orange
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   11);	/// 3 level
};
instance ITAR_VLK_H_12 (ItemPR_Armor)	///vlk yellow
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   12);	/// 3 level
};
instance ITAR_VLK_H_13 (ItemPR_Armor)	///vlk white
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   13);	/// 3 level
};
instance ITAR_VLK_H_14 (ItemPR_Armor)	///vlk dark-green
{
	...
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   14);	/// 3 level
};
instance ITAR_VLK_H_15 (ItemPR_Armor)	///vlk brown-gray
{
	name 			=	"Strój obywatela";
	visual 			=	"ItAr_VLK_M.3DS";
	visual_change 	=	"Armor_VLK_H.asc";
	SetItArAttributes (self, 15,0,0,   15);	/// 3 level
};
///******************************************************************************************
instance ITAR_Smith (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 20,5,0,   0);	/// 4 level
};
instance ITAR_Alchemist (ItemPR_Armor)
{
	...
	visual_change 	=	"Armor_Craftsman.asc";
	SetItArAttributes (self, 20,5,0,   1);	/// 4 level
};
instance ITAR_Scyther (ItemPR_Armor)
{
	name 			=	"Strój rzeŸnika";
	visual 			=	"ItAr_Smith.3DS";
	visual_change 	=	"Armor_Craftsman.asc";
	SetItArAttributes (self, 20,5,0,   2);	/// 4 level
};
instance ITAR_Barkeeper (ItemPR_Armor)
{
	...
	visual_change 	=	"Armor_Craftsman.asc";
	SetItArAttributes (self, 20,5,0,   3);	/// 4 level
};
...
///******************************************************************************************
instance ITAR_Leather_L (ItemPR_Armor)	///light leather
{
...
instance ITAR_Leather_T (ItemPR_Armor)	///tiger leather
{
	...
	SetItArAttributes (self, 45,15,15,   0);	/// 12 level
	description		=	"Pancerz ze skóry tygrysa";
};
instance ITAR_Leather_S (ItemPR_Armor)	///shadowbeast leather
{
	...
	visual 			=	"ItAr_Leather_L.3ds";
	visual_change 	=	"Armor_Leather_L.asc";
	SetItArAttributes (self, 55,20,20,   1);	/// 15 level
	description		=	"Pancerz ze skóry cieniostwora";
};
instance ITAR_Leather_H (ItemPR_Armor)	///troll armor
{
	name 			=	"Skórzany pancerz";
	visual 			=	"ItAr_Leather_L.3ds";
	visual_change 	=	"Armor_Leather_H.asc";
	SetItArAttributes (self, 65,25,25,   0);	/// 18 level
	description		=	"Pancerz ze skóry trolla";
};
instance ITAR_Leather_B (ItemPR_Armor)	///black troll armor
{
	name 			=	"Skórzany pancerz";
	visual 			=	"ItAr_Leather_L.3ds";
	visual_change 	=	"Armor_Leather_H.asc";
	SetItArAttributes (self, 75,30,30,   1);	/// 21 level
	description		=	"Pancerz ze skóry czarnego trolla";
};
///******************************************************************************************
///	Guild Armors
///******************************************************************************************
...
instance ITAR_ROY_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 145,100,100,   0);	/// 49 level
...
instance ITAR_ROY_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 170,120,120,   0);	/// 58 level
...
instance ITAR_DJG_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 120,85,80,   0);	/// 40 level
...
instance ITAR_DJG_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 150,115,90,   0);	/// 50 level
...
instance ITAR_DJG_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 180,140,100,   0);	/// 60 level
...
instance ITAR_Nov_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 30,5,15,   0);	/// 8 level
...
instance ITAR_Mag_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 80,40,40,   0);	/// 24 level
...
instance ITAR_Amg_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 150,135,135,   0);	/// 57 level
...
instance ITAR_PAL_L (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 125,75,80,   7);	/// 40 level
...
instance ITAR_PAL_M (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 150,95,105,   7);	/// 50 level
...
instance ITAR_PAL_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 175,115,130,   7);	/// 60 level
...
instance ITAR_PAL_D (ItemPR_Armor)
{
	...
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 175,115,130,   1);	/// 60 level
...
instance ITAR_PAL_T (ItemPR_Armor)
{
	...
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 175,115,130,   2);	/// 60 level
	description		=	"Ciê¿ki pancerz stra¿nika czasu";
	
	material 		=	MAT_METAL;
	on_equip		=	Equip_HeavyArmor;
	on_unequip		=	UnEquip_HeavyArmor;
};
instance ITAR_PAL_TM (ItemPR_Armor)
{
	name 			=	"Pancerz stra¿nika œwi¹tynnego";
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 175,115,130,   3);	/// 60 level
	description		=	"Ciê¿ki pancerz stra¿nika œwi¹tynnego";
...
{
	name 			=	"Pancerz podziemnych rycerzy";
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 175,130,115,   4);	/// 60 level
	description		=	"Ciê¿ki pancerz podziemnych rycerzy";
	
	material 		=	MAT_METAL;
	on_equip		=	Equip_HeavyArmor;
	on_unequip		=	UnEquip_HeavyArmor;
};
instance ITAR_PAL_A (ItemPR_Armor)
{
	name 			=	"Pancerz wojownika Targonu";
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 175,125,125,   5);	/// 60 level
	description		=	"Ciê¿ki pancerz wojownika Targonu";
	
	material 		=	MAT_METAL;
	on_equip		=	Equip_HeavyArmor;
	on_unequip		=	UnEquip_HeavyArmor;
};
instance ITAR_PAL_O (ItemPR_Armor)
{
	name 			=	"Pancerz orkowego wojownika";
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 180,120,120,   6);	/// 60 level
	description		=	"Ciê¿ki pancerz orkowego wojownika";
...
instance ITAR_PIR_H (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 60,15,15,   0);	/// 15 level
};
///******************************************************************************************
instance ITAR_RVN_L (ItemPR_Armor)
{
	name 			=	"Lekki pancerz Kruka";
	visual 			=	"ITAR_PIR_M_ADDON.3ds";
	visual_change 	=	"Armor_RVN_L.asc";
	SetItArAttributes (self, 50,10,10,   0);	/// 12 level
	TEXT[3]			=	PRINT_BanditArmor;
};
instance ITAR_RVN_M (ItemPR_Armor)
{
	name 			=	"Œredni pancerz Kruka";
...
///	Non-avaible Armors
///******************************************************************************************
instance ITAR_SLD_O (ItemPR_Armor)
{
	name 			=	"Pancerz najemnika orków";
	visual 			=	"ItAr_SLD_M.3ds";
	visual_change 	=	"Armor_SLD_O.asc";
	SetItArAttributes (self, 70,20,20,   0);	/// 18 level
	description		=	"Lekki pancerz najemnika orków";
};
///******************************************************************************************
instance ITAR_DMH_L (ItemPR_Armor)
{
	name 			=	"Pancerz ³owcy demonów";
	visual 			=	"ItAr_DJG_M.3ds";
	visual_change 	=	"Armor_DMH.asc";
	SetItArAttributes (self, 145,90,70,   0);	/// 45 level
	
	material 		=	MAT_METAL;
	on_equip		=	Equip_HeavyArmor;
	on_unequip		=	UnEquip_HeavyArmor;
};
instance ITAR_DMH_H (ItemPR_Armor)
{
	name 			=	"Pancerz ³owcy demonów";
	visual 			=	"ItAr_DJG_M.3ds";
	visual_change 	=	"Armor_DMH.asc";
	SetItArAttributes (self, 170,115,95,   1);	/// 55 level
...
instance ITAR_Dementor (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 125,100,100,   0);	/// 45 level
};
instance ITAR_Demaster (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 150,125,125,   1);	/// 55 level
};
instance ITAR_Death (ItemPR_Armor)
{
	name 			=	"P³aszcz Œmierci";
	visual 			=	"ItAr_Dementor.3ds";
	visual_change 	=	"Armor_Death.asc";
	SetItArAttributes (self, 175,150,150,   0);	/// 65 level
};
///******************************************************************************************
