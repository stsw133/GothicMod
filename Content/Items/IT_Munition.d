...
func void ARROW_CHECK()
{
	...
	if (Npc_IsEquippedItem_Bow(self) == true)
	{
...
func void BOLT_CHECK()
{
	...
	var c_item itm;	itm = Npc_GetEquippedRangedWeapon(self);
	if (Npc_IsEquippedItem_Crossbow(self) == true)
	{
...
func void AMMO_CHECK()
{
	...
	var c_item itm;	itm = Npc_GetEquippedRangedWeapon(self);
	if (Npc_IsEquippedItem_Gun(self) == true)
	{
...
func void HEAVYAMMO_CHECK()
{
	...
	var c_item itm;	itm = Npc_GetEquippedRangedWeapon(self);
	if (Npc_IsEquippedItem_HeavyGun(self) == true)
	{
