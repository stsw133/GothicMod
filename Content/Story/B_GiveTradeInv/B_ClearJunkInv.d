...
/*
		...
		Npc_RemoveInvItems	(slf, ItFo_Pear,				Npc_HasItems (slf, ItFo_Pear));
		Npc_RemoveInvItems	(slf, ItFo_Banana,				Npc_HasItems (slf, ItFo_Banana));
		Npc_RemoveInvItems	(slf, ItFo_Carrot,				Npc_HasItems (slf, ItFo_Carrot));
		Npc_RemoveInvItems	(slf, ItFo_Cheese,				Npc_HasItems (slf, ItFo_Cheese));
		Npc_RemoveInvItems	(slf, ItFo_WhiteCheese,			Npc_HasItems (slf, ItFo_WhiteCheese));
		...
		Npc_RemoveInvItems	(slf, ItFo_Potato,				Npc_HasItems (slf, ItFo_Potato));
		Npc_RemoveInvItems	(slf, ItFo_FishSoup,			Npc_HasItems (slf, ItFo_FishSoup));
		Npc_RemoveInvItems	(slf, ItFo_Onion,				Npc_HasItems (slf, ItFo_Onion));
		Npc_RemoveInvItems	(slf, ItFo_Sausage,				Npc_HasItems (slf, ItFo_Sausage));
		Npc_RemoveInvItems	(slf, ItFo_Egg,					Npc_HasItems (slf, ItFo_Egg));
		Npc_RemoveInvItems	(slf, ItFo_Honey,				Npc_HasItems (slf, ItFo_Honey));
		Npc_RemoveInvItems	(slf, ItFo_Chocolate,			Npc_HasItems (slf, ItFo_Chocolate));
		Npc_RemoveInvItems	(slf, ItFo_PineApple,			Npc_HasItems (slf, ItFo_PineApple));
		...
		Npc_RemoveInvItems	(slf, ItMi_FortuneCoin,			Npc_HasItems (slf, ItMi_FortuneCoin));
		Npc_RemoveInvItems	(slf, ItMi_AncientCoin,			Npc_HasItems (slf, ItMi_AncientCoin));
		Npc_RemoveInvItems	(slf, ItMi_OrcCoin,				Npc_HasItems (slf, ItMi_OrcCoin));
		...
		Npc_RemoveInvItems	(slf, ItMi_WhitePearl,			Npc_HasItems (slf, ItMi_WhitePearl));
		Npc_RemoveInvItems	(slf, ItMi_Ruby,				Npc_HasItems (slf, ItMi_Ruby));
		Npc_RemoveInvItems	(slf, ItMi_Diamond,				Npc_HasItems (slf, ItMi_Diamond));
		...
		Npc_RemoveInvItems	(slf, ItPl_Mushroom_03,			Npc_HasItems (slf, ItPl_Mushroom_03));
		Npc_RemoveInvItems	(slf, ItPl_Mushroom_04,			Npc_HasItems (slf, ItPl_Mushroom_04));
