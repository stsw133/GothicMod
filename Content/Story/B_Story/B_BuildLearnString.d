...
func void MOD_PrintLearn()
{
	...
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_SMITH) == 3)	{	PRINT_LearnTalent_Smith = PRINT_LearnTalent_Smith_4;	}
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_SMITH) == 4)	{	PRINT_LearnTalent_Smith = PRINT_LearnTalent_Smith_5;	};
	...
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_ALCHEMY) == 3)	{	PRINT_LearnTalent_Alchemy = PRINT_LearnTalent_Alchemy_4;	}
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_ALCHEMY) == 4)	{	PRINT_LearnTalent_Alchemy = PRINT_LearnTalent_Alchemy_5;	};
	...
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_HUNTING) == 3)	{	PRINT_LearnTalent_Hunting = PRINT_LearnTalent_Hunting_4;	}
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_HUNTING) == 4)	{	PRINT_LearnTalent_Hunting = PRINT_LearnTalent_Hunting_5;	};
	...
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_JEWELERY) == 3)	{	PRINT_LearnTalent_Jewelery = PRINT_LearnTalent_Jewelery_4;	}
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_JEWELERY) == 4)	{	PRINT_LearnTalent_Jewelery = PRINT_LearnTalent_Jewelery_5;	};
	...
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_WRITING) == 3)	{	PRINT_LearnTalent_Writing = PRINT_LearnTalent_Writing_4;	}
	else if	(Npc_GetTalentValue(hero,NPC_TALENT_WRITING) == 4)	{	PRINT_LearnTalent_Writing = PRINT_LearnTalent_Writing_5;	};
};
