...
func int B_TeachFightTalentPercent (var C_NPC slf, var C_NPC oth, var int talent, var int percent, var int teacherMAX)
{
	...
	{	
		B_AddFightSkill (oth, NPC_TALENT_1H, percent);	//Einhand steigern
	...
	{	
		B_AddFightSkill (oth, NPC_TALENT_2H, percent);	//Zweihand steigern
	...
	{	
		B_AddFightSkill (oth, NPC_TALENT_BOW, percent);	//Bogen steigern
	...
	{	
		B_AddFightSkill (oth, NPC_TALENT_CROSSBOW, percent);	//Crossbow steigern
