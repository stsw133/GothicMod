...
func int B_TeachMagicCircle (var C_NPC slf, var C_NPC oth, var int circle)
{
	// ------ Kosten festlegen ------
	var int kosten;
	kosten = B_GetLearnCostTalent(oth, NPC_TALENT_MAGIC, circle);
	...
	// ------ Kreis setzen ------
	Npc_SetTalentSkill (oth, NPC_TALENT_MAGIC, circle);
	...
	if (circle == 1)
	{
		PrintScreen	(PRINT_LearnMagic_1, -1, -1, FONT_Screen, 2);
	...
	if (circle == 2)
	{
		PrintScreen	(PRINT_LearnMagic_2, -1, -1, FONT_Screen, 2);
	...
	if (circle == 3)
	{
		PrintScreen	(PRINT_LearnMagic_3, -1, -1, FONT_Screen, 2);
	...
	if (circle == 4)
	{
		PrintScreen	(PRINT_LearnMagic_4, -1, -1, FONT_Screen, 2);
	...
	if (circle == 5)
	{
		PrintScreen	(PRINT_LearnMagic_5, -1, -1, FONT_Screen, 2);
	...
	if (circle == 6)
	{
		PrintScreen	("Nauka: szósty kr¹g magii", -1, -1, FONT_Screen, 2);
