...
{	
	...
	if ((B_GiveInvItems(other, self, itmi_gold, 10)) && (Npc_GetTalentSkill(other,NPC_TALENT_PERSUASION) == false))
	|| ((B_GiveInvItems(other, self, itmi_gold, 9)) && (Npc_GetTalentSkill(other,NPC_TALENT_PERSUASION) == true))
	{	
		...
		B_GiveInvItems (self,other,ItFo_Grog,1);
	}
...
{	
	...
	if ((B_GiveInvItems(other, self, itmi_gold, 30)) && (Npc_GetTalentSkill(other,NPC_TALENT_PERSUASION) == false))
	|| ((B_GiveInvItems(other, self, itmi_gold, 27)) && (Npc_GetTalentSkill(other,NPC_TALENT_PERSUASION) == true))
	{
		...
		B_GiveInvItems (self,other,ItFo_Rum,1);
	}
	else
	{
...
{	
	...
	if (Samuel_Stronger_Varianz == 0)
	{
		...
		B_GiveInvItems (self,other,ItFo_Hooch,1);
		B_UseItem (other, ItFo_Hooch);
...
{	
	...
	Npc_RemoveInvItems	(self, ItFo_Grog, Npc_HasItems (self,ItFo_Grog) );
	CreateInvItems 	(self, ItFo_Grog, 15);
