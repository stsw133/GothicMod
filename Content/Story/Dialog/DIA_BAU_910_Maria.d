...
func int DIA_Maria_Mission_Condition()
{
	...
	&& (QuestStep_MariaPlate != LOG_SUCCESS)
	{
		return true;
	};
};
...
func void DIA_Maria_Mission_Info()
{
	...
	QuestStep_MariaPlate = SetQuestStatus(Quest_MariaPlate, LOG_RUNNING, QuestStep_MariaPlate);
};
...
func void DIA_Maria_BringPlate_Info()
{
	...
	QuestStep_MariaPlate = SetQuestStatus (Quest_MariaPlate, LOG_SUCCESS, QuestStep_MariaPlate);
...
{
	if (QuestStep_MariaPlate == LOG_SUCCESS)
