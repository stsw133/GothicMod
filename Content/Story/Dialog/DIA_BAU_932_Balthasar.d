...
{
	if (Npc_KnowsInfo(other,DIA_Balthasar_HALLO))
	&& ((QuestStep_BanditTrader == LOG_RUNNING)
...
func void DIA_Addon_Balthasar_Rangerbandits_Info()
{
	...
	if (QuestStep_BanditTrader == LOG_RUNNING)
	{
...
func void DIA_Balthasar_TALKTOBENGAR_Info()
{
	...
	QuestStep_BalthasarSheeps = SetQuestStatus (Quest_BalthasarSheeps, LOG_RUNNING, QuestStep_BalthasarSheeps);
	SetNoteEntry (Quest_BalthasarSheeps, LOG_MISSION, "Farmer Bengar zabroni³ pasterzowi Balthasarowi zabieraæ owce na p³askowy¿.");
};
...
{
	if ((Npc_KnowsInfo(other,DIA_Balthasar_TALKTOBENGAR))
	&& (QuestStep_BalthasarSheeps == LOG_SUCCESS)
	&& ((hero.guild == GIL_NONE) || (hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
	&& ((!Npc_IsDead(BalthasarSheep1)) || (!Npc_IsDead(BalthasarSheep2)) || (!Npc_IsDead(BalthasarSheep3))))
	{
		return true;
...
func void DIA_Balthasar_BENGARUEBERREDET_Info()
{
	...
	QuestStep_BalthasarSheeps = SetQuestStatus (Quest_BalthasarSheeps, LOG_SUCCESS, QuestStep_BalthasarSheeps);
	B_GivePlayerXP(XP_BONUS_1);
...
func void DIA_Balthasar_PERMKAP1_Info()
{
	...
	if (((Wld_DetectNpc(self,Balthasar_Sheep1,NOFUNC,-1) && (Npc_GetDistToNpc(self,other) < 2000))
