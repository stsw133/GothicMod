...
{
	if ((QuestStep_LazyBronko == LOG_RUNNING) || (Babera_BronkoKeinBauer == true))
...
func void DIA_Bronko_KEINBAUER_Info()
{
	...
	if (hero.guild == GIL_NONE)
	{
		...
		if (QuestStep_LazyBronko == LOG_RUNNING)
		{	
...
func void DIA_Bronko_KEINBAUER_SLD()
{
	...
	QuestStep_LazyBronko = SetQuestStatus (Quest_LazyBronko, LOG_SUCCESS, QuestStep_LazyBronko);
...
func void DIA_Bronko_FLEISSIG_Info()
{
	...
	else if (QuestStep_LazyBronko == LOG_SUCCESS)
	{
