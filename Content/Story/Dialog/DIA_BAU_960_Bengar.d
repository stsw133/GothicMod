...
func void DIA_Addon_Bengar_MissingPeople_Info()
{
	...
	SetNoteEntry (Quest_MissingPeople, LOG_MISSION, "Zagin¹³ robotnik farmera Bengara, Pardos.");
...
{
	if (QuestStep_TorlofMilitia == LOG_RUNNING)
...
{
	if (QuestStep_BalthasarSheeps == LOG_RUNNING)
...
func void DIA_Bengar_BALTHASAR_Info()
{
	...
	SetNoteEntry (Quest_BalthasarSheeps, LOG_MISSION, "Jeœli mam przekonaæ Bengara, aby wpuœci³ Balthasara z powrotem na swoje pastwiska, bêdê musia³ wyœwiadczyæ mu przys³ugê. Na pewno wkrótce nadarzy siê ku temu jakaœ okazja.");
	B_GivePlayerXP(XP_BONUS_0);
};

//******************************************************************************************
//	BalthasarDarfAufWeide
//******************************************************************************************
...
func void DIA_Bengar_BALTHASARDARFAUFWEIDE_Info()
{
	...
	QuestStep_BalthasarSheeps = SetQuestStatus (Quest_BalthasarSheeps, LOG_PROGRESS, QuestStep_BalthasarSheeps);
	B_GivePlayerXP(XP_BONUS_1);
};
