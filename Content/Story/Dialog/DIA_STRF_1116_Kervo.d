...
func void DIA_Kervo_HILFE_Info()
{
	...
	QuestStep_KervoKillLurker = LOG_RUNNING;
};
...
func void DIA_Kervo_HILFE_Problem()
{
	...
	QuestStep_KervoKillLurker = SetQuestStatus (Quest_KervoKillLurker, LOG_RUNNING, QuestStep_KervoKillLurker);
...
{
	if (QuestStep_KervoKillLurker == LOG_RUNNING)
...
func void DIA_Kervo_LurkerPlatt_Info()
{
	...
	QuestStep_KervoKillLurker = SetQuestStatus (Quest_KervoKillLurker, LOG_SUCCESS, QuestStep_KervoKillLurker);
};
...
{
	if (QuestStep_KervoKillLurker == LOG_SUCCESS)
	{
		return true;
	};
};
