...
FUNC VOID DIA_Gerbrandt_Perm_Info()
{
	...
	{
		if (QuestStep_DiegoResidence != LOG_SUCCESS)
		{
			if (hero.guild != GIL_KDF)
			&& (hero.guild != GIL_PAL)
			{
...
{
	if (QuestStep_DiegoResidence == LOG_RUNNING)
...
FUNC VOID DIA_Gerbrandt_GreetingsFromDiego_Info()
{
	...
	QuestStep_DiegoResidence = SetQuestStatus (Quest_DiegoResidence, LOG_SUCCESS, QuestStep_DiegoResidence);
