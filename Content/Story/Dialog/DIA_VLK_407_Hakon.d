...
func void DIA_Hakon_Hallo_Info()
{
	...
	SetNoteEntry (Note_Traders, LOG_NOTE, "Hakon sprzedaje broñ na targowisku.");
};
...
func void DIA_Addon_Hakon_MissingPeople_Info()
{
	...
	QuestStep_WhereIsJoe = SetQuestStatus (Quest_WhereIsJoe, LOG_RUNNING, QuestStep_WhereIsJoe);
	SetNoteEntry (Quest_WhereIsJoe, LOG_MISSION, "Hakon, kupiec z Khorinis, twierdzi, ¿e cz³owiek o imieniu Joe znikn¹³ bez œladu. Podobno Joe wiedzia³, jak dostaæ siê do wie¿ miejskich, w których przechowywana jest broñ stra¿y.");
...
{
	if (Npc_KnowsInfo(other,DIA_Hakon_HaradBandits))
	|| (Npc_KnowsInfo(other,DIA_Hakon_OutOfTown))
	{
		return true;
	};
};
...
func void DIA_Hakon_Banditen_Info()
{
	...
	QuestStep_HakonBandits = SetQuestStatus (Quest_HakonBandits, LOG_RUNNING, QuestStep_HakonBandits);
	SetNoteEntry (Quest_HakonBandits, LOG_MISSION, "Handlarz broni¹, Hakon, zosta³ obrabowany poza murami miasta przez bandytów.");
};
...
func void DIA_Hakon_Miliz_Info()
{
	...
	SetNoteEntry (Quest_HakonBandits, LOG_MISSION, "Pablo, cz³onek stra¿y miejskiej, bra³ udzia³ w bezowocnych poszukiwaniach bandytów.");
};
...
func void DIA_Hakon_Success_Info()
{
	...
	QuestStep_HakonBandits = SetQuestStatus (Quest_HakonBandits, LOG_SUCCESS, QuestStep_HakonBandits);
