...
FUNC VOID DIA_Gaertner_Plants_Info()
{
	...
	SetNoteEntry (Note_Traders, LOG_NOTE, "Ogrodnik gubernatora mo¿e mi sprzedaæ roœliny.");
};
...
{	
	...
	Npc_RemoveInvItems (self, ItMi_SwampTabak, 1);
...
{
	if (Npc_KnowsInfo(other,DIA_Cassia_Aufnahme))
	{
		return true;
	};
};
