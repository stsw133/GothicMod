...
func void DIA_Bosper_BringFur_Info ()
{
	...
	if (B_GiveInvItems (other, self, ItAt_WolfFur, 6))		
	{
		...
		B_GiveInvItems (self, other, itmi_gold, (ItAt_WolfFur.value * 6));
...
func void DIA_Bosper_SellFur_Info ()
{
	...
	|| (Npc_HasItems(other, ItAt_KeilerFur) > 0)
	{
		...
		if (Npc_HasItems(other, ItAt_ShadowFur) > 0)
		{
			...
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_ShadowFur) * ItAt_ShadowFur.value) );
		...
		|| (Npc_HasItems(other, ItAt_TrollBlackFur) > 0)
		{
			...
			if (Npc_HasItems(other, ItAt_TrollFur) > 0)
			{
				B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_TrollFur) * ItAt_TrollFur.value) );
			...
			if (Npc_HasItems(other, ItAt_TrollBlackFur) > 0)
			{
				...
				B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_TrollBlackFur) * ItAt_TrollBlackFur.value) );
