...
func void DIA_Bosper_LEHRLING_OK()
{
	...
	CreateInvItem (other, ItAr_Hunter);
	AI_EquipArmor (other, ItAr_Hunter);
...
func void DIA_Bosper_SellFur_Info ()
{
	...
	|| (Npc_HasItems(other, ItAt_KeilerFur) > 0)
	{
		...
		{
			AI_Wait (self,2);
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_KeilerFur) * 15) );
		...
		if (Npc_HasItems(other, ItAt_SheepFur) > 0)
		{
			...
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_SheepFur) * 10) );
		...
		if (Npc_HasItems(other, ItAt_WolfFur) > 0)
		{
			...
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_WolfFur) * 10) );
		...
		if (Npc_HasItems(other, ItAt_WargFur) > 0)
		{
			...
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_WargFur) * 250) );
		...
		if (Npc_HasItems(other, ItAt_ShadowFur) > 0)
		{
			...
			B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_ShadowFur) * 250) );
		...
		|| (Npc_HasItems(other, ItAt_TrollBlackFur) > 0)
		{
			...
			if (Npc_HasItems(other, ItAt_TrollFur) > 0)
			{
				B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_TrollFur) * 300) );
			...
			if (Npc_HasItems(other, ItAt_TrollBlackFur) > 0)
			{
				...
				B_GiveInvItems(self, other, itmi_gold, (Npc_HasItems(other, ItAt_TrollBlackFur) * 350) );
