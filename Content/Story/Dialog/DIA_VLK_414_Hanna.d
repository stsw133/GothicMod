...
FUNC VOID DIA_Hanna_AnyNews_Yes ()
{
	...
	QuestStep_HannaMap = SetQuestStatus (Quest_HannaMap, LOG_RUNNING, QuestStep_HannaMap);
	SetNoteEntry (Quest_HannaMap, LOG_MISSION, "Hanna zgubi³a pewien dokument. Najprawdopodobniej znajduje siê on w dzielnicy portowej, gdzie mieœci siê siedziba kartografa Brahima.");
...
FUNC VOID DIA_Hanna_AnyNews_Yes_Reward_BeNice()
{
	...
	QuestStep_HannaMap = SetQuestStatus (Quest_HannaMap, LOG_FAILED, QuestStep_HannaMap);
...
{
	if (QuestStep_HannaMap == LOG_RUNNING)
...
FUNC VOID DIA_Hanna_ThisLetter_Info()
{
	...
	QuestStep_HannaMap = SetQuestStatus (Quest_HannaMap, LOG_SUCCESS, QuestStep_HannaMap);
