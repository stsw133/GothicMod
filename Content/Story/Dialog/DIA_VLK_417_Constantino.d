...
func void DIA_Constantino_HerbsRunning_Success()
{
	...
	AI_PrintScreen ("Oddano roœliny", -1, YPOS_ItemGiven, FONT_ScreenSmall, 2);
...
func void DIA_Constantino_LEHRLING_Yes()
{
	...
	CreateInvItems (other, ItAr_Alchemist, 1);
	AI_EquipArmor (other, ItAr_Alchemist);
...
FUNC VOID DIA_Constantino_MushroomsRunning_Info()
{
	...
	|| (Npc_HasItems (other, ItPl_Mushroom_03) > 0)
	|| (Npc_HasItems (other, ItPl_Mushroom_04) > 0)
	{
...
func void DIA_Constantino_MushroomsRunning_Sell()
{
	...
	if (Npc_HasItems(other,ItPl_Mushroom_01) > 0)
	{
		...
		B_GiveInvItems (self, other, itmi_gold, (Npc_HasItems(other,ItPl_Mushroom_01) * 10) );
	...
	|| (Npc_HasItems(other,ItPl_Mushroom_04) > 0)
	{
		...
		if (Npc_HasItems(other,ItPl_Mushroom_03) > 0)
		{
			B_GiveInvItems (self, other, itmi_gold, (Npc_HasItems(other,ItPl_Mushroom_03) * 10) );
			B_GiveInvItems (other, self, ItPl_Mushroom_03, Npc_HasItems (other, ItPl_Mushroom_03));
		};
		if (Npc_HasItems(other,ItPl_Mushroom_04) > 0)
		{
			B_GiveInvItems (self, other, itmi_gold, (Npc_HasItems(other,ItPl_Mushroom_04) * 10) );
			B_GiveInvItems (other, self, ItPl_Mushroom_04, Npc_HasItems (other, ItPl_Mushroom_04));
		};
	};
