...
func void DIA_Coragon_HALLO_Info()
{
	...
	SetNoteEntry (Note_Traders, LOG_NOTE, "Jedzenie i napoje mogê kupiæ u w³aœciciela gospody, Coragona.");
};
...
func void DIA_Addon_Coragon_MissingPeople_Info()
{
	...
	QuestStep_WhoStolePeople = SetQuestStatus (Quest_WhoStolePeople, LOG_RUNNING, QuestStep_WhoStolePeople);
	SetNoteEntry (Quest_WhoStolePeople, LOG_MISSION, "Hakon, kupiec z targowiska, i stolarz Thorben podobno wiedz¹ coœ na temat zaginionych ludzi.");
};
...
func void DIA_Coragon_Bestohlen_Info()
{
	...
	QuestStep_CoragonSilver = SetQuestStatus (Quest_CoragonSilver, LOG_RUNNING, QuestStep_CoragonSilver);
};
...
{
	if (QuestStep_CoragonSilver == LOG_RUNNING)
...
func void DIA_Coragon_BringSilber_Info()
{
	...
	QuestStep_CoragonSilver = SetQuestStatus (Quest_CoragonSilver, LOG_SUCCESS, QuestStep_CoragonSilver);
};
...
{
	if (Valentino.aivar[AIV_DefeatedByPlayer] == DBP_Defeated)
	{
...
func int DIA_Coragon_Ring_Condition()
{
	...
	&& (Npc_HasItems(other,ItRi_Valentino) > 0)
	{
		return true;
	};
};
...
func void DIA_Coragon_Ring_Info()
{
	...
	B_GiveInvItems (other, self, ItRi_Valentino, 1);
