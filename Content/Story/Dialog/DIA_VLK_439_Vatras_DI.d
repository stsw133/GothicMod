...
FUNC VOID DIA_Vatras_DI_Talente_CIRCLES()
{
	...
	{ 
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Pierwszy kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 1))			,DIA_Vatras_DI_Talente_Circle_1);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGIC) == 1)
	{
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Drugi kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 2))			,DIA_Vatras_DI_Talente_Circle_2);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGIC) == 2)
	{
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Trzeci kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 3))			,DIA_Vatras_DI_Talente_Circle_3);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGIC) == 3)
	{
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Czwarty kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 4))			,DIA_Vatras_DI_Talente_Circle_4);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGIC) == 4)	
	{
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Pi¹ty kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 5))			,DIA_Vatras_DI_Talente_Circle_5);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGIC) == 5)
	{
		Info_AddChoice		(DIA_Vatras_DI_Talente, B_BuildLearnString("Szósty kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGIC, 6))			,DIA_Vatras_DI_Talente_Circle_6);
	};
};
