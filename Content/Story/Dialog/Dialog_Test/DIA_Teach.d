...
FUNC VOID DIA_Teach_JOIN_Info()
{
	...
	|| (Hlp_GetInstanceID(self) == VLK_449_Lares_DI))
	{
	 ...
	 if ((Npc_GetTalentSkill(other,NPC_TALENT_MAGIC) == 0)
	&& (Kapitel >= 7)
	...
	|| (Hlp_GetInstanceID(self) == KDW_14000_Addon_Saturas_ADW)
	|| (Hlp_GetInstanceID(self) == PC_Mage_OW)))
	 || ((Npc_GetTalentSkill(other,NPC_TALENT_MAGIC) == 3)
	&& (Kapitel >= 9)
	&& ((Hlp_GetInstanceID(self) == KDF_503_Karras)
	|| (Hlp_GetInstanceID(self) == KDW_14000_Addon_Saturas_ADW)
	|| (Hlp_GetInstanceID(self) == VLK_439_Vatras_DI)))
	 || ((Npc_GetTalentSkill(other,NPC_TALENT_MAGIC) == 4)
	&& (Kapitel >= 10)
	&& ((Hlp_GetInstanceID(self) == KDF_500_Pyrokar)
	|| (Hlp_GetInstanceID(self) == VLK_439_Vatras_DI)))
	{
	...
	|| (Hlp_GetInstanceID(self) == SLD_811_Wolf_DI)))
	 || ((Npc_GetTalentSkill(other,NPC_TALENT_CROSSBOW) < 1)
	...
	&& ((Hlp_GetInstanceID(self) == DJG_712_Hokurn)
