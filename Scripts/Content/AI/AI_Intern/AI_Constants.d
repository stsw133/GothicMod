...
const int AIV_MM_Real_ID					=	43;
	const int ID_ALLIGATOR				= 1;
	const int ID_AVATAR					= 1 + ID_ALLIGATOR;
	const int ID_BEAR					= 1 + ID_AVATAR;
	const int ID_BITER					= 1 + ID_BEAR;
	const int ID_BLATTCRAWLER			= 1 + ID_BITER;
	const int ID_BLOODFLY				= 1 + ID_BLATTCRAWLER;
	const int ID_BLOODHOUND				= 1 + ID_BLOODFLY;
	const int ID_DEMON					= 1 + ID_BLOODHOUND;
	const int ID_DEMON_LORD				= 1 + ID_DEMON;
	const int ID_DEMONICON				= 1 + ID_DEMON_LORD;
	const int ID_DOG					= 1 + ID_DEMONICON;
	const int ID_DRACONIAN				= 1 + ID_DOG;
	const int ID_DRAGON					= 1 + ID_DRACONIAN;
	const int ID_DRAGON_BLACK			= 1 + ID_DRAGON;
	const int ID_DRAGON_FIRE			= 1 + ID_DRAGON_BLACK;
	const int ID_DRAGON_GOLD			= 1 + ID_DRAGON_FIRE;
	const int ID_DRAGON_ICE				= 1 + ID_DRAGON_GOLD;
	const int ID_DRAGON_ROCK			= 1 + ID_DRAGON_ICE;
	const int ID_DRAGON_SWAMP			= 1 + ID_DRAGON_ROCK;
	const int ID_DRAGON_UNDEAD			= 1 + ID_DRAGON_SWAMP;
	const int ID_DRAGONHARPY			= 1 + ID_DRAGON_UNDEAD;
	const int ID_DRAGONSNAPPER			= 1 + ID_DRAGONHARPY;
	const int ID_FIREGOLEM				= 1 + ID_DRAGONSNAPPER;
	const int ID_FIREWARAN				= 1 + ID_FIREGOLEM;
	const int ID_GARGOYLE				= 1 + ID_FIREWARAN;
	const int ID_GIANTSNAPPER			= 1 + ID_GARGOYLE;
	const int ID_GIANT_BUG				= 1 + ID_GIANTSNAPPER;
	const int ID_GIANT_RAT				= 1 + ID_GIANT_BUG;
	const int ID_GIANT_SPIDER			= 1 + ID_GIANT_RAT;
	const int ID_GOAT					= 1 + ID_GIANT_SPIDER;
	const int ID_GOBBO					= 1 + ID_GOAT;
	const int ID_GOBBO_BANDIT			= 1 + ID_GOBBO;
	const int ID_GOBBO_BLACK			= 1 + ID_GOBBO_BANDIT;
	const int ID_GOBBO_SHAMAN			= 1 + ID_GOBBO_BLACK;
	const int ID_GOBBO_SKELETON			= 1 + ID_GOBBO_SHAMAN;
	const int ID_GOBBO_WARRIOR			= 1 + ID_GOBBO_SKELETON;
	const int ID_GOLEM					= 1 + ID_GOBBO_WARRIOR;
	const int ID_GORILLA				= 1 + ID_GOLEM;
	const int ID_HARE					= 1 + ID_GORILLA;
	const int ID_HARPY					= 1 + ID_HARE;
	const int ID_ICEGOLEM				= 1 + ID_HARPY;
	const int ID_ICEWOLF				= 1 + ID_ICEGOLEM;
	const int ID_INKBUG					= 1 + ID_ICEWOLF;
	const int ID_JACKAL					= 1 + ID_INKBUG;
	const int ID_KEILER					= 1 + ID_JACKAL;
	const int ID_LURKER					= 1 + ID_KEILER;
	const int ID_MEATBUG				= 1 + ID_LURKER;
	const int ID_MINECRAWLER			= 1 + ID_MEATBUG;
	const int ID_MINECRAWLERWARRIOR		= 1 + ID_MINECRAWLER;
	const int ID_MINECRAWLERQUEEN		= 1 + ID_MINECRAWLERWARRIOR;
	const int ID_MOLERAT				= 1 + ID_MINECRAWLERQUEEN;
	const int ID_MUMMY					= 1 + ID_MOLERAT;
	const int ID_OGRE					= 1 + ID_MUMMY;
	const int ID_ORC					= 1 + ID_OGRE;
	const int ID_ORCCHAMPION			= 1 + ID_ORC;
	const int ID_ORCELITE				= 1 + ID_ORCCHAMPION;
	const int ID_ORCGUARDIAN			= 1 + ID_ORCELITE;
	const int ID_ORCSHAMAN				= 1 + ID_ORCGUARDIAN;
	const int ID_ORCSOLDIER				= 1 + ID_ORCSHAMAN;
	const int ID_ORCWARRIOR				= 1 + ID_ORCSOLDIER;
	const int ID_RAZOR					= 1 + ID_ORCWARRIOR;
	const int ID_SCAVENGER				= 1 + ID_RAZOR;
	const int ID_SCAVENGER_DEMON		= 1 + ID_SCAVENGER;
	const int ID_SHADOWBEAST			= 1 + ID_SCAVENGER_DEMON;
	const int ID_SHADOWBEAST_FIRE		= 1 + ID_SHADOWBEAST;
	const int ID_SHADOWBEAST_SKELETON	= 1 + ID_SHADOWBEAST_FIRE;
	const int ID_SHEEP					= 1 + ID_SHADOWBEAST_SKELETON;
	const int ID_SKELETON				= 1 + ID_SHEEP;
	const int ID_SKELETON_DARK			= 1 + ID_SKELETON;
	const int ID_SKELETON_LORD			= 1 + ID_SKELETON_DARK;
	const int ID_SKELETON_MAGE			= 1 + ID_SKELETON_LORD;
	const int ID_SKELETON_WARRIOR		= 1 + ID_SKELETON_MAGE;
	const int ID_SLEEPER				= 1 + ID_SKELETON_WARRIOR;
	const int ID_SLIME					= 1 + ID_SLEEPER;
	const int ID_SNAPPER				= 1 + ID_SLIME;
	const int ID_SPINT					= 1 + ID_SNAPPER;
	const int ID_STONEGUARDIAN			= 1 + ID_SPINT;
	const int ID_SUMMONED				= 1 + ID_STONEGUARDIAN;
	const int ID_SUMMONED_EVIL			= 1 + ID_SUMMONED;
	const int ID_SUMMONED_UNDEAD		= 1 + ID_SUMMONED_EVIL;
	const int ID_SWAMPDRONE				= 1 + ID_SUMMONED_UNDEAD;
	const int ID_SWAMPGOLEM				= 1 + ID_SWAMPDRONE;
	const int ID_SWAMPSHARK				= 1 + ID_SWAMPGOLEM;
	const int ID_TIGER					= 1 + ID_SWAMPSHARK;
	const int ID_TREANT					= 1 + ID_TIGER;
	const int ID_TROLL					= 1 + ID_TREANT;
	const int ID_TROLL_BLACK			= 1 + ID_TROLL;
	const int ID_UNDEADORCWARRIOR		= 1 + ID_TROLL_BLACK;
	const int ID_VAMPHARPY				= 1 + ID_UNDEADORCWARRIOR;
	const int ID_WARAN					= 1 + ID_VAMPHARPY;
	const int ID_WARG					= 1 + ID_WARAN;
	const int ID_WEREWOLF				= 1 + ID_WARG;
	const int ID_WISP					= 1 + ID_WEREWOLF;
	const int ID_WOLF					= 1 + ID_WISP;
	const int ID_WOLF_SKELETON			= 1 + ID_WOLF;
	const int ID_ZOMBIE					= 1 + ID_WOLF_SKELETON;
...
const int AIV_CanOffer						=	53;	/// new!!!		[ORG: AIV_FreezeStateTime]
	const int OFFER_Games				= 1 << 0;
	const int OFFER_Teaching			= 1 << 1;
	const int OFFER_Trading				= 1 << 2;
...
/// ------ News override ------
const int AIV_NewsOverride					=	58;	/// merged!!!
...
const int GOLD_PER_LP					=	50;	/// new!!!

const int HP_PER_LP						=	4;	/// new!!!
const int MP_PER_LP						=	2;	/// new!!!
const int SP_PER_LP						=	5;	/// new!!!
