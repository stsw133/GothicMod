...
const int SPL_Cost_NecSkeleton			=	60;

///******************************************************************************************
instance Spell_NecSkeleton (C_Spell_Proto)
{
	time_per_mana						=	0;
	targetCollectAlgo					=	TARGET_COLLECT_NONE;
};

func int Spell_Logic_NecSkeleton (var int manaInvested)
{
	if (Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_NecSkeleton/SPL_Cost_Scroll))
	|| (self.attribute[ATR_MANA] >= SPL_Cost_NecSkeleton)
	{
		return SPL_SENDCAST;
	};
	return SPL_SENDSTOP;
...
func void Spell_Cast_NecSkeleton()
{
	if (Npc_GetActiveSpellIsScroll(self))
	{
		self.attribute[ATR_MANA] -= SPL_Cost_NecSkeleton/SPL_Cost_Scroll;
	}
	else
	{
		self.attribute[ATR_MANA] -= SPL_Cost_NecSkeleton;
	...
	{
		Wld_SpawnNpcRange (self, Skeleton_Warrior, 1, 500);
	};
