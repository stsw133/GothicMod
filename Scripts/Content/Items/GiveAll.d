...
func void GiveAll_Potions (var C_Npc slf)
{
	...
	//CreateInvItems (slf, ItPo_Shield_Addon_04, 10);
	//CreateInvItems (slf, ItPo_Shield_Addon_05, 10);
	//CreateInvItems (slf, ItPo_Shield_Addon_06, 10);
...
func void GiveAll_Recipes (var C_Npc slf)
{
	...
	CreateInvItem (slf, ItRe_ALCHEMY_Health_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_05);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_Addon_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_Addon_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_Addon_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_Addon_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Health_Addon_05);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_05);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_Addon_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_Addon_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_Addon_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_Addon_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Mana_Addon_05);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Stamina_Addon_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Stamina_Addon_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Stamina_Addon_03);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_05);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_06);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_03);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_04);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_05);
	CreateInvItem (slf, ItRe_ALCHEMY_Blueplant_Addon_06);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Shield_01);
	CreateInvItem (slf, ItRe_ALCHEMY_Shield_02);
	CreateInvItem (slf, ItRe_ALCHEMY_Shield_03);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Health);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Mana);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Stamina);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Str);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Dex);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Pow);
	CreateInvItem (slf, ItRe_ALCHEMY_Temp_Prot);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Health);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Mana);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Stamina);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Str);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Dex);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Pow);
	CreateInvItem (slf, ItRe_ALCHEMY_Perm_Prot);
	
	CreateInvItem (slf, ItRe_ALCHEMY_Geist);
	CreateInvItem (slf, ItRe_ALCHEMY_HealObsession);
	CreateInvItem (slf, ItRe_ALCHEMY_NightVision);
	CreateInvItem (slf, ItRe_ALCHEMY_Perfume);
	CreateInvItem (slf, ItRe_ALCHEMY_Poison);
	CreateInvItem (slf, ItRe_ALCHEMY_Speed);
	CreateInvItem (slf, ItRe_ALCHEMY_Stealth);
	CreateInvItem (slf, ItRe_ALCHEMY_Underwater);
	...
	CreateInvItem (slf, ItRe_COOKING_DarkBeer);
...
func void GiveAll_Runes (var C_Npc slf)
{
	...
	CreateInvItem (slf, ItRu_MindControl);
	CreateInvItem (slf, ItRu_PickLock);
...
func void GiveAll_Written (var C_Npc slf)
{
	...
	/// xp books
	CreateInvItem (slf, ItWr_BookXp_01a); CreateInvItem (slf, ItWr_BookXp_01b);
	CreateInvItem (slf, ItWr_BookXp_02a); CreateInvItem (slf, ItWr_BookXp_02b);
	CreateInvItem (slf, ItWr_BookXp_03a); CreateInvItem (slf, ItWr_BookXp_03b);
	CreateInvItem (slf, ItWr_BookXp_04a); CreateInvItem (slf, ItWr_BookXp_04b);
	CreateInvItem (slf, ItWr_BookXp_05a); CreateInvItem (slf, ItWr_BookXp_05b);
	CreateInvItem (slf, ItWr_BookXp_06a); CreateInvItem (slf, ItWr_BookXp_06b);
	CreateInvItem (slf, ItWr_BookXp_07a); CreateInvItem (slf, ItWr_BookXp_07b);
	CreateInvItem (slf, ItWr_BookXp_08a); CreateInvItem (slf, ItWr_BookXp_08b);
	CreateInvItem (slf, ItWr_BookXp_09a); CreateInvItem (slf, ItWr_BookXp_09b);
	CreateInvItem (slf, ItWr_BookXp_10a); CreateInvItem (slf, ItWr_BookXp_10b);
	CreateInvItem (slf, ItWr_BookXp_11a); CreateInvItem (slf, ItWr_BookXp_11b);
	CreateInvItem (slf, ItWr_BookXp_12a); CreateInvItem (slf, ItWr_BookXp_12b);
	CreateInvItem (slf, ItWr_BookXp_13a); CreateInvItem (slf, ItWr_BookXp_13b);
	CreateInvItem (slf, ItWr_BookXp_14a); CreateInvItem (slf, ItWr_BookXp_14b);
	CreateInvItem (slf, ItWr_BookXp_15a); CreateInvItem (slf, ItWr_BookXp_15b);
	CreateInvItem (slf, ItWr_BookXp_16a); CreateInvItem (slf, ItWr_BookXp_16b);
	CreateInvItem (slf, ItWr_BookXp_17a); CreateInvItem (slf, ItWr_BookXp_17b);
	CreateInvItem (slf, ItWr_BookXp_18a); CreateInvItem (slf, ItWr_BookXp_18b);
	CreateInvItem (slf, ItWr_BookXp_19a); CreateInvItem (slf, ItWr_BookXp_19b);
	CreateInvItem (slf, ItWr_BookXp_20a); CreateInvItem (slf, ItWr_BookXp_20b);
	CreateInvItem (slf, ItWr_BookXp_21a); CreateInvItem (slf, ItWr_BookXp_21b);
	CreateInvItem (slf, ItWr_BookXp_22a); CreateInvItem (slf, ItWr_BookXp_22b);
	CreateInvItem (slf, ItWr_BookXp_23a); CreateInvItem (slf, ItWr_BookXp_23b);
	CreateInvItem (slf, ItWr_BookXp_24a); CreateInvItem (slf, ItWr_BookXp_24b);
	CreateInvItem (slf, ItWr_BookXp_25a); CreateInvItem (slf, ItWr_BookXp_25b);
	CreateInvItem (slf, ItWr_BookXp_26a); CreateInvItem (slf, ItWr_BookXp_26b);
	CreateInvItem (slf, ItWr_BookXp_27a); CreateInvItem (slf, ItWr_BookXp_27b);
	CreateInvItem (slf, ItWr_BookXp_28a); CreateInvItem (slf, ItWr_BookXp_28b);
	CreateInvItem (slf, ItWr_BookXp_29a); CreateInvItem (slf, ItWr_BookXp_29b);
	CreateInvItem (slf, ItWr_BookXp_30a); CreateInvItem (slf, ItWr_BookXp_30b);
	CreateInvItem (slf, ItWr_BookXp_31a); CreateInvItem (slf, ItWr_BookXp_31b);
	CreateInvItem (slf, ItWr_BookXp_32a); CreateInvItem (slf, ItWr_BookXp_32b);
	CreateInvItem (slf, ItWr_BookXp_33a); CreateInvItem (slf, ItWr_BookXp_33b);
	CreateInvItem (slf, ItWr_BookXp_34a); CreateInvItem (slf, ItWr_BookXp_34b);
	CreateInvItem (slf, ItWr_BookXp_35a); CreateInvItem (slf, ItWr_BookXp_35b);
	CreateInvItem (slf, ItWr_BookXp_36a); CreateInvItem (slf, ItWr_BookXp_36b);
	CreateInvItem (slf, ItWr_BookXp_37a); CreateInvItem (slf, ItWr_BookXp_37b);
	CreateInvItem (slf, ItWr_BookXp_38a); CreateInvItem (slf, ItWr_BookXp_38b);
	CreateInvItem (slf, ItWr_BookXp_39a); CreateInvItem (slf, ItWr_BookXp_39b);
	CreateInvItem (slf, ItWr_BookXp_40a); CreateInvItem (slf, ItWr_BookXp_40b);
	CreateInvItem (slf, ItWr_BookXp_41a); CreateInvItem (slf, ItWr_BookXp_41b);
	CreateInvItem (slf, ItWr_BookXp_42a); CreateInvItem (slf, ItWr_BookXp_42b);
	CreateInvItem (slf, ItWr_BookXp_43a); CreateInvItem (slf, ItWr_BookXp_43b);
	CreateInvItem (slf, ItWr_BookXp_44a); CreateInvItem (slf, ItWr_BookXp_44b);
	CreateInvItem (slf, ItWr_BookXp_45a); CreateInvItem (slf, ItWr_BookXp_45b);
	CreateInvItem (slf, ItWr_BookXp_46a); CreateInvItem (slf, ItWr_BookXp_46b);
	CreateInvItem (slf, ItWr_BookXp_47a); CreateInvItem (slf, ItWr_BookXp_47b);
	CreateInvItem (slf, ItWr_BookXp_48a); CreateInvItem (slf, ItWr_BookXp_48b);
	CreateInvItem (slf, ItWr_BookXp_49a); CreateInvItem (slf, ItWr_BookXp_49b);
	CreateInvItem (slf, ItWr_BookXp_50a); CreateInvItem (slf, ItWr_BookXp_50b);
	CreateInvItem (slf, ItWr_BookXp_51a); CreateInvItem (slf, ItWr_BookXp_51b);
	CreateInvItem (slf, ItWr_BookXp_52a); CreateInvItem (slf, ItWr_BookXp_52b);
	CreateInvItem (slf, ItWr_BookXp_53a); CreateInvItem (slf, ItWr_BookXp_53b);
	CreateInvItem (slf, ItWr_BookXp_54a); CreateInvItem (slf, ItWr_BookXp_54b);
	CreateInvItem (slf, ItWr_BookXp_55a); CreateInvItem (slf, ItWr_BookXp_55b);
	CreateInvItem (slf, ItWr_BookXp_56a); CreateInvItem (slf, ItWr_BookXp_56b);
	CreateInvItem (slf, ItWr_BookXp_57a); CreateInvItem (slf, ItWr_BookXp_57b);
	CreateInvItem (slf, ItWr_BookXp_58a); CreateInvItem (slf, ItWr_BookXp_58b);
	CreateInvItem (slf, ItWr_BookXp_59a); CreateInvItem (slf, ItWr_BookXp_59b);
	CreateInvItem (slf, ItWr_BookXp_60a); CreateInvItem (slf, ItWr_BookXp_60b);
	CreateInvItem (slf, ItWr_BookXp_61a); CreateInvItem (slf, ItWr_BookXp_61b);
	CreateInvItem (slf, ItWr_BookXp_62a); CreateInvItem (slf, ItWr_BookXp_62b);
	CreateInvItem (slf, ItWr_BookXp_63a); CreateInvItem (slf, ItWr_BookXp_63b);
	CreateInvItem (slf, ItWr_BookXp_64a); CreateInvItem (slf, ItWr_BookXp_64b);
	CreateInvItem (slf, ItWr_BookXp_65a); CreateInvItem (slf, ItWr_BookXp_65b);
	CreateInvItem (slf, ItWr_BookXp_66a); CreateInvItem (slf, ItWr_BookXp_66b);
	CreateInvItem (slf, ItWr_BookXp_67a); CreateInvItem (slf, ItWr_BookXp_67b);
	CreateInvItem (slf, ItWr_BookXp_68a); CreateInvItem (slf, ItWr_BookXp_68b);
	CreateInvItem (slf, ItWr_BookXp_69a); CreateInvItem (slf, ItWr_BookXp_69b);
	CreateInvItem (slf, ItWr_BookXp_70a); CreateInvItem (slf, ItWr_BookXp_70b);
	CreateInvItem (slf, ItWr_BookXp_71a); CreateInvItem (slf, ItWr_BookXp_71b);
	CreateInvItem (slf, ItWr_BookXp_72a); CreateInvItem (slf, ItWr_BookXp_72b);
	CreateInvItem (slf, ItWr_BookXp_73a); CreateInvItem (slf, ItWr_BookXp_73b);
	CreateInvItem (slf, ItWr_BookXp_74a); CreateInvItem (slf, ItWr_BookXp_74b);
	CreateInvItem (slf, ItWr_BookXp_75a); CreateInvItem (slf, ItWr_BookXp_75b);
