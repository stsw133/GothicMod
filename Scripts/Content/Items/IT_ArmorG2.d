...
instance ITAR_Crawler (ItemPR_Armor)
{
	...
	SetItArAttributes (self, 65,25,5,   0);	/// 16 level
	description		=	"Zbroja z pancerzy pe³zaczy";
};
///******************************************************************************************
///	MIL & ROY armors
///******************************************************************************************
...
instance ITAR_PAL_U (ItemPR_Armor)
{
	...
	description		=	"Ciê¿ki pancerz rycerzy podziemia";
...
{
	name 			=	"Pancerz orkowego najemnika";
	visual 			=	"ItAr_Pal_H3.3ds";
	visual_change 	=	"Armor_PAL_H.asc";
	SetItArAttributes (self, 180,120,120,   6);	/// 60 level
	description		=	"Ciê¿ki pancerz orkowego najemnika";
...
///	Prisoner armors
///******************************************************************************************
instance ITAR_Prisoner (ItemPR_Armor)
{
	name 			=	"£achy skazañca";
