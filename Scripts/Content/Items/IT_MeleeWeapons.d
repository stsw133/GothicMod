...
///******************************************************************************************
func void Equip_2H_2_StaffWeapon()
{
...
func void UnEquip_2H_2_StaffWeapon()
{
	Mdl_RemoveOverlayMDS (self, "HUMANS_2HST3.MDS");
};
///******************************************************************************************
func void SetItMwAttributes (var C_Item itm, var int type, var int dmg, var int dmgType, var int str, var int dex, var int rng, var int valuePercent)
{
	itm.flags				=	type;
	
	itm.value				=	((dmg*11-(str+dex)*5/6 + itm.change_value[2]*50) * (200+rng)/200) * valuePercent/100;
...
instance ItMw_1H_Mace_L_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 2,DAM_EDGE, 5,1, 50, 12);
};
instance ItMw_1H_Mace_L_03 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 4,DAM_BLUNT, 10,2, 70, 12);
};
instance ItMw_Nagelknueppel (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 6,DAM_BLUNT, 15,3, 60, 12);
};
instance ItMw_Sense (ItemPR_MeleeWeapon)
{
	name 					=	"Ma³a kosa";
	visual 					=	"ItMw_012_1h_Scythe_01.3DS";
	SetItMwAttributes (self, ITEM_SWD, 6,DAM_EDGE, 15,3, 60, 12);
};
instance ItMw_1H_Mace_L_04 (ItemPR_MeleeWeapon)
{
	name 					=	"M³ot kowalski";
	visual 					=	"ItMw_010_1h_sledgehammer_01.3DS";
	SetItMwAttributes (self, ITEM_AXE, 8,DAM_BLUNT, 20,4, 30, 12);
};
/// ------ MIL ------
instance ItMw_1h_Mil_Sword (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 16,DAM_EDGE, 40,8, 90, 12);
};
instance ItMw_1h_NordmarSword (ItemPR_MeleeWeapon)
{
	name 					=	"Miecz nordmarczyka";
	visual 					=	"ItMw_1h_NordmarSchwert.3DS";
	SetItMwAttributes (self, ITEM_SWD, 20,DAM_EDGE, 50,10, 70, 12);
};
/// ------ PAL ------
instance ItMw_1h_Pal_Sword (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 28,DAM_EDGE, 70,14, 70, 12);
};
instance ItMw_2h_Pal_Sword (ItemPR_MeleeWeapon)
{
	name 					=	"Miecz dwurêczny paladyna";
	visual 					=	"ItMw_040_2h_PAL_Sword_03.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD, 36,DAM_EDGE, 90,18, 110, 12);
};
/// ------ VLK ------
instance ItMw_1h_Vlk_Mace (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 3,DAM_BLUNT, 8,2, 70, 12);
};
instance ItMw_1h_Vlk_Dagger (ItemPR_MeleeWeapon)
{
	name 					=	"Sztylet";
	visual 					=	"Itmw_005_1h_dagger_01.3DS";
	SetItMwAttributes (self, ITEM_SWD, 5,DAM_EDGE, 4,10, 50, 12);
};
instance ItMw_1h_Vlk_Axe (ItemPR_MeleeWeapon)
{
	name 					=	"Topór";
	visual 					=	"Itmw_010_1h_vlk_hatchet_01.3DS";
	SetItMwAttributes (self, ITEM_AXE, 8,DAM_EDGE, 	20,4, 50, 12);
};
instance ItMw_1h_Vlk_Sword (ItemPR_MeleeWeapon)
{
	name 					=	"Miecz";
	visual 					=	"ItMw_018_1h_SwordCane_01.3ds";
	SetItMwAttributes (self, ITEM_SWD, 10,DAM_EDGE, 8,20, 70, 12);
};
/// ------ NOV ------
instance ItMw_1h_Nov_Mace (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 12,DAM_BLUNT, 30,6, 130, 12);
};
instance ItMw_RangerStaff_Addon (ItemPR_MeleeWeapon)
{
	...
	material				=	MAT_WOOD;
	visual 					=	"ItMw_020_2h_Nov_Staff_01.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 15,DAM_BLUNT, 30,6, 130, 12);
};
/// ------ SLD ------
...
instance ItMw_2H_Scythe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 24,DAM_EDGE, 60,12, 130, 12);
};
/// ------ BDT ------
instance ItMw_Addon_BanditTrader (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 14,DAM_EDGE, 35,7, 90, 12);
...
instance ItMw_2H_Axe_L_01 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE|ITEM_NSPLIT, 12,DAM_EDGE, 30,6, 60, 12);
};
/// ------ PIR ------
instance ItMw_Addon_PIR1hAxe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 20,DAM_EDGE, 50,10, 60, 12);
};
...
instance ItMw_Addon_PIR2hAxe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 28,DAM_EDGE, 70,14, 80, 12);
};
instance ItMw_Addon_PIR2hSword (ItemPR_MeleeWeapon)
{	
	name 					=	"Miecz pok³adowy";
	visual 					=	"ItMw_070_2h_sword_09.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD, 28,DAM_EDGE, 70,14, 120, 12);
};
/// ------ others ------
...
{	
	...
	SetItMwAttributes (self, ITEM_SWD, 24,DAM_EDGE, 60,12, 75, 12);
};
///******************************************************************************************
///	Goblin weapons
///******************************************************************************************
instance ItMw_1H_Goblin_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 2,DAM_BLUNT, 10,2, 90, 8);
};
instance ItMw_1H_Goblin_02 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 3,DAM_BLUNT, 15,3, 90, 8);
};
instance ItMw_1H_Goblin_03 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 4,DAM_BLUNT, 20,4, 90, 8);
};
instance ItMw_1H_Goblin_04 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 5,DAM_BLUNT, 25,5, 90, 8);
};
///******************************************************************************************
///	Orc weapons
///******************************************************************************************
instance ItMw_2H_Draconian (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 21,DAM_EDGE, 105,21, 100, 8);
};
/// ------ Axe ------
instance ItMw_2H_OrcAxe_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 15,DAM_EDGE, 75,15, 100, 8);
};
instance ItMw_2H_OrcAxe_02 (ItemPR_MeleeWeapon)
{
	name 					=	"Krush UrRok";
	visual 					=	"ItMw_2H_OrcAxe_02.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 18,DAM_EDGE, 90,18, 110, 8);
};
instance ItMw_2H_OrcAxe_03 (ItemPR_MeleeWeapon)
{
	name 					=	"Krush Agash";
	visual 					=	"ItMw_2H_OrcAxe_03.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 21,DAM_EDGE, 105,21, 110, 8);
};
instance ItMw_2H_OrcAxe_04 (ItemPR_MeleeWeapon)
{
	name 					=	"Krush BrokDar";
	visual 					=	"ItMw_2H_OrcAxe_04.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 27,DAM_EDGE, 135,27, 130, 8);
};
/// ------ Mace ------
instance ItMw_2H_OrcMace_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 18,DAM_BLUNT, 90,18, 110, 8);
};
instance ItMw_2H_OrcMace_02 (ItemPR_MeleeWeapon)
{
	name 					=	"Krush EdRosh";
	visual 					=	"ItMw_2H_OrcMace_02.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 24,DAM_BLUNT, 120,24, 120, 8);
};
/// ------ Staff ------
instance ItMw_2H_OrcStaff_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 15,DAM_BLUNT, 75,15, 100, 8);
};
/// ------ Sword ------
instance ItMw_2H_OrcSword_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 24,DAM_EDGE, 120,24, 100, 8);
};
instance ItMw_2H_OrcSword_02 (ItemPR_MeleeWeapon)
{
	name 					=	"Krush Tarrok";
	visual 					=	"ItMw_2H_OrcSword_02.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD, 27,DAM_EDGE, 135,27, 100, 8);
};
/// ------ Elite ------
instance ItMw_2H_OrcElite_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 30,DAM_EDGE, 150,30, 140, 8);
};
///******************************************************************************************
/// Chapter 1 - trader
///******************************************************************************************
...
instance ItMw_2h_Bau_Axe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 40,DAM_EDGE, 40,8, 70, 100);
};
...
instance ItMw_Kriegskeule (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 50,DAM_BLUNT, 50,10, 50, 100);
};
instance ItMw_Richtstab (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 50,DAM_EDGE, 40,8, 110, 100);
};
instance ItMw_Kriegshammer1 (ItemPR_MeleeWeapon) 
{
	name 					=	"M³ot wojenny";
	visual 					=	"ItMw_028_1h_warhammer_01.3DS";
	SetItMwAttributes (self, ITEM_AXE, 55,DAM_BLUNT, 55,11, 40, 100);
};
instance ItMw_Hellebarde (ItemPR_MeleeWeapon) 
{
	name 					=	"Halabarda";
	visual 					=	"itmw_028_2h_halberd_01.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 55,DAM_EDGE, 55,11, 80, 100);
};
instance ItMw_Nagelkeule2 (ItemPR_MeleeWeapon)
{
	...
	material 				=	MAT_WOOD;
	visual 					=	"ItMw_018_1h_Mace_01.3DS";
	SetItMwAttributes (self, ITEM_AXE, 60,DAM_BLUNT, 60,12, 60, 100);
};
instance ItMw_Schiffsaxt (ItemPR_MeleeWeapon)
{
	name 					=	"Topór marynarski";
	visual 					=	"ItMw_030_1h_axe_01.3DS";
	SetItMwAttributes (self, ITEM_AXE, 60,DAM_EDGE, 60,12, 70, 100);
};
///******************************************************************************************
...
instance ItMw_1H_Common_01 (ItemPR_MeleeWeapon)
{
	...
	change_atr[2]			=	8+NPC_TALENT_1H;
	change_value[2]			=	2;
	
	SetItMwAttributes (self, ITEM_SWD, 40,DAM_EDGE, 30,6, 90, 100);
...
instance ItMw_Schwert1 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 60,DAM_EDGE, 50,10, 70, 100);
...
instance ItMw_Schwert (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 65,DAM_EDGE, 65,13, 90, 100);
};
instance ItMw_2H_WarScythe (ItemPR_MeleeWeapon)
{
	name 					=	"Kosa bojowa";
	visual 					=	"ITROX_2H_SCYTHE_WAR.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 65,DAM_EDGE, 65,13, 130, 100);
};
instance ItMw_Piratensaebel (ItemPR_MeleeWeapon)
{
	name 					=	"Piracki kordelas";
	visual 					=	"ItMw_030_1h_sword_03.3DS";
	SetItMwAttributes (self, ITEM_SWD, 65,DAM_EDGE, 60,12, 70, 100);
};
instance ItMw_Stabkeule (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 70,DAM_BLUNT, 70,14, 130, 100);
};
instance ItMw_FaustSchwert (ItemPR_MeleeWeapon)
{
	name 					=	"Szpony";
	visual 					=	"ITROX_FAUSTSCHWERT.3DS";
	SetItMwAttributes (self, ITEM_SWD, 70,DAM_EDGE, 20,50, 60, 100);
};
...
instance ItMw_Schwert4 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 80,DAM_EDGE, 70,14, 90, 100);
...
instance ItMw_1h_Special_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 60,DAM_EDGE, 40,8, 90, 100);
...
instance ItMw_2h_Special_01 (ItemPR_MeleeWeapon)
{
	...
	change_atr[2]			=	8+NPC_TALENT_2H;
	change_value[2]			=	2;
	
	SetItMwAttributes (self, ITEM_2HD_SWD, 80,DAM_EDGE, 60,12, 100, 100);
...
instance ItMw_1h_Ignite_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 40,DAM_EDGE|DAM_FIRE, 40,8, 90, 100);
...
instance ItMw_2h_Ignite_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 60,DAM_EDGE|DAM_FIRE, 60,12, 100, 100);
...
instance ItMw_Rubinklinge (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_SWD, 100,DAM_EDGE, 90,18, 70, 100);
...
instance ItMw_ElBastardo (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 115,DAM_EDGE, 105,21, 100, 100);
...
instance ItMw_1h_Special_02 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_SWD, 100,DAM_EDGE, 80,16, 90, 100);
...
instance ItMw_2h_Special_02 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 120,DAM_EDGE, 100,20, 110, 100);
...
instance ItMw_1h_Ignite_02 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_SWD, 80,DAM_EDGE|DAM_FIRE, 80,16, 90, 100);
...
instance ItMw_2h_Ignite_02 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 100,DAM_EDGE|DAM_FIRE, 100,20, 110, 100);
...
instance ItMw_Avalon (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 145,DAM_EDGE, 135,27, 130, 100);
...
instance ItMw_1h_Special_03 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 140,DAM_EDGE, 120,24, 100, 100);
...
instance ItMw_2h_Special_03 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 160,DAM_EDGE, 140,28, 130, 100);
...
instance ItMw_1h_Ignite_03 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 120,DAM_EDGE|DAM_FIRE, 120,24, 100, 100);
...
instance ItMw_2h_Ignite_03 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 140,DAM_EDGE|DAM_FIRE, 140,28, 130, 100);
...
instance ItMw_Drachenschneide (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 190,DAM_EDGE, 160,32, 120, 100);
};
instance ItMw_Berserkeraxt (ItemPR_MeleeWeapon)
{
	name 					=	"Topór berserkera";
	visual 					=	"ItMw_080_2h_axe_heavy_02.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 195,DAM_EDGE, 170,34, 90, 100);
};
///******************************************************************************************
...
instance ItMw_1h_Special_04 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 180,DAM_EDGE, 160,32, 120, 100);
...
instance ItMw_2h_Special_04 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 200,DAM_EDGE, 180,36, 140, 100);
...
instance ItMw_1h_Ignite_04 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 160,DAM_EDGE|DAM_FIRE, 160,32, 120, 100);
...
instance ItMw_2h_Ignite_04 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 180,DAM_EDGE|DAM_FIRE, 180,36, 140, 100);
...
instance ItMw_1h_Keule (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 50,DAM_BLUNT, 60,12, 65, 50);
};
instance ItMw_2h_Keule (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 100,DAM_BLUNT, 120,24, 130, 50);
};
instance ItMw_Addon_Betty (ItemPR_MeleeWeapon)
{
	name 					=	"Betty";
	visual 					=	"ItMw_065_1h_sword_bastard_03.3DS";
	SetItMwAttributes (self, ITEM_SWD, 130,DAM_EDGE, 40,100, 100, 50);
};
///******************************************************************************************
...
instance ItMw_1h_Special_05 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 220,DAM_EDGE, 200,40, 120, 100);
...
instance ItMw_2h_Special_05 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 240,DAM_EDGE, 220,44, 140, 100);
...
instance ItMw_1h_Ignite_05 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 200,DAM_EDGE|DAM_FIRE, 200,40, 120, 100);
...
instance ItMw_2h_Ignite_05 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 220,DAM_EDGE|DAM_FIRE, 220,44, 140, 100);
...
instance ItMw_Stab_L_01 (ItemPR_MeleeWeapon)
{
	...
	mag_circle 				=	1;
	change_atr[2]			=	ATR_MANA_MAX;
	change_value[2]			=	10;
	effect					=	"SPELLFX_MAGESTAFF1";
	
	SetItMwAttributes (self, ITEM_2HD_AXE, 30,DAM_BLUNT|DAM_MAGIC, 30,0, 110, 100);
...
instance ItMw_Stab_M_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 60,DAM_BLUNT|DAM_MAGIC, 60,0, 120, 100);
...
instance ItMw_Stab_M_02 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 75,DAM_EDGE|DAM_MAGIC, 60,12, 120, 100);
...
instance ItMw_Stab_H_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 90,DAM_BLUNT|DAM_MAGIC, 90,0, 130, 100);
...
instance ItMw_Stab_H_02 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 105,DAM_EDGE|DAM_MAGIC, 90,18, 130, 100);
...
instance ItMw_1H_Blessed_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 100,DAM_EDGE|DAM_MAGIC, 100,60, 100, 100);
...
instance ItMw_2H_Blessed_01 (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 120,DAM_EDGE|DAM_MAGIC, 120,60, 130, 100);
...
instance ItMw_1H_Blessed_02 (ItemPR_MeleeWeapon)
{
	...
	visual 					=	"ItMw_030_1h_PAL_sword_bastard_RAW_01.3DS";
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 120,DAM_EDGE|DAM_MAGIC, 100,90, 100, 100);
...
instance ItMw_2H_Blessed_02 (ItemPR_MeleeWeapon) 
{
	name 					=	"Miecz Zakonu";
	visual 					=	"ItMw_040_2h_PAL_sword_heavy_RAW_01.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 140,DAM_EDGE|DAM_MAGIC, 120,90, 130, 100);
...
instance ItMw_1H_Blessed_03 (ItemPR_MeleeWeapon)
{
	name 					=	"Œwiêty Gniew";
	visual 					=	"ItMw_030_1h_PAL_sword_bastard_RAW_01.3DS";
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 140,DAM_EDGE|DAM_MAGIC, 100,120, 100, 100);
...
instance ItMw_2H_Blessed_03 (ItemPR_MeleeWeapon) 
{
	name 					=	"Œwiêty Kat";
	visual 					=	"ItMw_040_2h_PAL_sword_heavy_RAW_01.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 160,DAM_EDGE|DAM_MAGIC, 120,120, 130, 100);
...
instance ItMw_1H_Innos (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 160,DAM_EDGE|DAM_MAGIC, 100,150, 90, 100);
...
instance ItMw_2H_Innos (ItemPR_MeleeWeapon) 
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 180,DAM_EDGE|DAM_MAGIC, 120,150, 140, 100);
...
instance ItMw_AlriksSword_Mis (ItemPR_MeleeWeapon)
{
	name 					=	"Miecz Alrika";
	visual 					=	"ItMw_025_1h_sld_sword_01.3DS";
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 30,DAM_EDGE, 30,6, 70, 20);
};
instance ItMw_2h_Rod (ItemPR_MeleeWeapon)
{
	name 					=	"Miecz dwurêczny Roda";
	visual 					=	"ItMw_035_2h_sld_sword_01.3DS";
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 50,DAM_EDGE, 50,10, 130, 20);
};
instance Holy_Hammer_MIS (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE|ITEM_MISSION, 50,DAM_BLUNT, 0,0, 100, 0);
};
instance ItMw_1H_FerrosSword_Mis (ItemPR_MeleeWeapon) 
{
	name 					=	"Miecz Ferosa";
	visual 					=	"ItMw_060_1h_Sword_smith_03.3DS";
	SetItMwAttributes (self, ITEM_SWD|ITEM_MISSION, 100,DAM_EDGE, 90,18, 90, 20);
};
instance ItMw_BeliarWeapon_Raven (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD|ITEM_MISSION, 50,DAM_BLUNT, 0,0, 120, 0);
	cond_atr[2]   			=	ATR_MANA_MAX;
	cond_value[2]  			=	666666;
	TEXT[2]					=	"";
	TEXT[3]					=	"";
...
instance ItMw_Steel_Axe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 0,DAM_EDGE, 0,0, 70, 10);
};
instance ItMw_Steel_BroadSword (ItemPR_MeleeWeapon)
{
	name 					=	"Stalowy szeroki miecz";
	visual 					=	"Steel_broadsword.3ds";
	SetItMwAttributes (self, ITEM_SWD, 0,DAM_EDGE, 0,0, 0, 10);
};
...
instance ItMw_Steel_Club (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 0,DAM_BLUNT, 0,0, 0, 10);
};
...
instance ItMw_Steel_HeavyClaymore (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 0,DAM_EDGE, 0,0, 0, 10);
};
...
instance ItMw_Steel_WarAxe (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 0,DAM_EDGE, 0,0, 0, 10);
};
...
instance ItMw_Broom (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_AXE, 10,DAM_BLUNT, 10,2, 130, 4);
};
instance ItMw_Pan (ItemPR_MeleeWeapon)
{
	name 					=	"Patelnia";
	visual 					=	"ITMI_PAN.3DS";
	SetItMwAttributes (self, ITEM_AXE, 15,DAM_BLUNT, 15,3, 60, 4);
};
instance ItMw_1H_Club_01 (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_AXE, 20,DAM_BLUNT, 20,4, 100, 4);
};
instance ItMw_Spade (ItemPR_MeleeWeapon)
{
	name 					=	"£opata";
	visual 					=	"ITMI_SPADE.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 25,DAM_BLUNT, 25,5, 130, 4);
};
instance ItMw_MegaPan (ItemPR_MeleeWeapon)
{
	name 					=	"Mega patelnia";
	visual 					=	"ItroX_Blutpfanne.3DS";
	SetItMwAttributes (self, ITEM_2HD_AXE, 50,DAM_BLUNT, 50,10, 130, 4);
};
instance ItMw_FireSword (ItemPR_MeleeWeapon)
{
	name 					=	"Ognisty miecz";
	visual 					=	"ItMw_FireSword_04.3DS";
	SetItMwAttributes (self, ITEM_SWD, 150,DAM_FIRE, 150,30, 130, 80);
};
instance ItMw_BusterSword (ItemPR_MeleeWeapon)
{
	name 					=	"Ogromny tasak";
	visual 					=	"ItMw_Buster_Sword.3ds";
	SetItMwAttributes (self, ITEM_2HD_SWD, 200,DAM_EDGE, 200,40, 180, 80);
};
instance ItMw_ChainSaw (ItemPR_MeleeWeapon)
{
	name 					=	"Pi³a ³añcuchowa";
	visual 					=	"itmw_1h_chainsaw.3ds";
	SetItMwAttributes (self, ITEM_SWD, 250,DAM_EDGE, 90,150, 100, 80);
};
///******************************************************************************************
instance ItMw_LightSaber (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_SWD, 300,DAM_INVALID, 60,150, 0, 120);
};
instance ItMw_LightSaber_Blue (ItemPR_MeleeWeapon)
{
	...
	SetItMwAttributes (self, ITEM_2HD_SWD, 300,DAM_POINT, 60,150, 120, 120);
};
