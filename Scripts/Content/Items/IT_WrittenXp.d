...
instance ItWr_BookXp_01a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(1, "Na granicy úwiat≥a", 1);
...
instance ItWr_BookXp_01b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(1, "Na granicy úwiat≥a", 2);
	TEXT[0]						=	"Zapiski mistrza Telariona z Uniwersytetu ArkanÛw,";
	TEXT[1]						=	"sporzπdzone podczas podrÛøy badawczej";
	TEXT[2]						=	"do Doliny Mgie≥, roku 37 po Drugim Z≥πczeniu.";
};
...
instance ItWr_BookXp_02a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(2, "Cisza poúrÛd wzgÛrz", 1);
...
instance ItWr_BookXp_02b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(2, "Cisza poúrÛd wzgÛrz", 2);
	TEXT[0]						=	"Fragment dziennikÛw badawczych brata Envalda,";
	TEXT[1]						=	"klasztor w Treomarze. Rok 22 po Drugim Z≥πczeniu.";
};
...
instance ItWr_BookXp_03a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(3, "UwiÍziony g≥os", 1);
...
instance ItWr_BookXp_03b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(3, "UwiÍziony g≥os", 2);
	TEXT[0]						=	"Esej autorstwa Arcymaga Relmira,";
	TEXT[1]						=	"sporzπdzony na polecenie Rady PiÍciu.";
	TEXT[2]						=	"Zakazany do kopiowania bez zgody.";
};
...
instance ItWr_BookXp_06a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(6, "W cieniu Prze≥Íczy", 1);
...
instance ItWr_BookXp_06b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(6, "W cieniu Prze≥Íczy", 2);
	TEXT[0]						=	"Zapiski Harlena Gorretha, podrÛønika";
	TEXT[1]						=	"i kartografa z krÛlestwa Ilvar.";
	TEXT[2]						=	"Znalezione przy jego ciele w dolinie Ysnar.";
};
...
instance ItWr_BookXp_09a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(9, "Z wnÍtrza bestii", 1);
...
instance ItWr_BookXp_09b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(9, "Z wnÍtrza bestii", 2);
	TEXT[0]						=	"Zapiski Ebrama z Harn,";
	TEXT[1]						=	"by≥ego uzdrowiciela, skryby i pustelnika.";
	TEXT[2]						=	"Odrzucone przez wszystkie szko≥y uczone.";
};
...
instance ItWr_BookXp_10a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(10, "KoúÊ ponad duszÍ", 1);
...
instance ItWr_BookXp_10b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(10, "KoúÊ ponad duszÍ", 2);
	TEXT[0]						=	"Notatki archiwisty Elmarina z Wydzia≥u";
	TEXT[1]						=	"Religii Porzuconych. Klasztor w Trystan,";
	TEXT[2]						=	"rok 61 po Drugim Pochodzie.";
};
...
instance ItWr_BookXp_12a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(12, "Klπtwa øycia", 1);
...
instance ItWr_BookXp_12b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(12, "Klπtwa øycia", 2);
	TEXT[0]						=	"Zapiski medyka krÛlewskiego Raltana Vossara.";
	TEXT[1]						=	"Spisano w roku 73 po Wojnie Trzech Bram.";
	TEXT[2]						=	"ZbiÛr zdeponowany w archiwum medycznym Therelis.";
};
...
instance ItWr_BookXp_14a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(14, "O skÛrze", 1);
...
instance ItWr_BookXp_14b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(14, "O skÛrze", 2);
	TEXT[0]						=	"Fragment podrÍcznika mistrza Edgara";
	TEXT[1]						=	"z warsztatu przy wschodnim targu w Karthil.";
	TEXT[2]						=	"Zakazany przez cech za Ñzbyt dosadny tonî.";
};
...
instance ItWr_BookXp_15a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(15, "Bitwa w cieúninie", 1);
...
instance ItWr_BookXp_15b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(15, "Bitwa w cieúninie", 2);
	TEXT[0]						=	"Spisane przez kapitana Arvonna Vel Tern,";
	TEXT[1]						=	"by≥ego dowÛdcÍ øaglowca ÑGniew Po≥udniaî.";
	TEXT[2]						=	"Fragment pamiÍtnika odnalezionego w Myrth.";
};
...
instance ItWr_BookXp_16a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(16, "Milczenie bogÛw", 1);
...
instance ItWr_BookXp_16b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(16, "Milczenie bogÛw", 2);
	TEXT[0]						=	"Fragment pokutnej ksiÍgi brata Alinora,";
	TEXT[1]						=	"spisany w klasztorze na WzgÛrzach Kruka.";
	TEXT[2]						=	"Nigdy nie w≥πczony do oficjalnego kanonu.";
};
...
instance ItWr_BookXp_17a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(17, "Z popio≥Ûw nocy", 1);
...
instance ItWr_BookXp_17b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(17, "Z popio≥Ûw nocy", 2);
	TEXT[0]						=	"Spisane przez rycerza Edricha,";
	TEXT[1]						=	"jednego ze úwiadkÛw Bitwy pod Bramant.";
	TEXT[2]						=	"Przechowywane w kaplicy åwiÍtego P≥omienia.";
};
...
instance ItWr_BookXp_18a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(18, "Bez pieczÍci", 1);
...
instance ItWr_BookXp_18b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(18, "Bez pieczÍci", 2);
	TEXT[0]						=	"Testament spisany przez Sirela Doventa,";
	TEXT[1]						=	"by≥ego skryby wojskowego,";
	TEXT[2]						=	"wiÍzionego w Podziemiach WrÛt Zachodnich.";
};
...
instance ItWr_BookXp_22a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(22, "Spod fundamentÛw", 1);
...
instance ItWr_BookXp_22b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(22, "Spod fundamentÛw", 2);
	TEXT[0]						=	"Spisane przez mistrza murarskiego";
	TEXT[1]						=	"Ervona Halda, odnalezione w ruinach";
	TEXT[2]						=	"klasztoru Arnem. Tekst czÍúciowo przepalony.";
};
...
instance ItWr_BookXp_31a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(31, "Godzina úmierci", 1);
...
instance ItWr_BookXp_31b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(31, "Godzina úmierci", 2);
	TEXT[0]						=	"Ostatnie zapiski mistrza Deirama,";
	TEXT[1]						=	"zegarmistrza z pÛ≥nocnego";
	TEXT[2]						=	"kwarta≥u Gildenvy, rok nieznany.";
};
...
instance ItWr_BookXp_32a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(32, "Jak rodzπ siÍ potwory", 1);
...
instance ItWr_BookXp_32b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(32, "Jak rodzπ siÍ potwory", 2);
	TEXT[0]						=	"Zapisy kap≥ana Enratha z Domu RÛwnowagi,";
	TEXT[1]						=	"sporzπdzone w úwiπtyni Adanosa w Setarze,";
	TEXT[2]						=	"rok 93 po Zawarciu Trzeciego Rozejmu.";
};
...
instance ItWr_BookXp_36a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(36, "Lud rzπdzπcy samym sobπ", 1);
...
instance ItWr_BookXp_36b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(36, "Lud rzπdzπcy samym sobπ", 2);
	TEXT[0]						=	"Spisane przez lorda Emerika z rodu Langvenn,";
	TEXT[1]						=	"po wieczerzy z panem Aldorem z Warthall,";
	TEXT[2]						=	"roku 214 po Koronacji Rodu WewnÍtrznego.";
};
...
instance ItWr_BookXp_37a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(37, "Rozwaøania kata", 1);
...
instance ItWr_BookXp_37b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(37, "Rozwaøania kata", 2);
	TEXT[0]						=	"Spisane przez Lewarka z Dareth,";
	TEXT[1]						=	"urzÍdowego wykonawcÍ wyrokÛw";
	TEXT[2]						=	"KrÛlewskiej Marchii PÛ≥nocnej.";
};
...
instance ItWr_BookXp_38a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(38, "Uúmiech z porcelany", 1);
...
instance ItWr_BookXp_38b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(38, "Uúmiech z porcelany", 2);
	TEXT[0]						=	"Fragmenty prywatnych zapiskÛw krÛlewskiego";
	TEXT[1]						=	"b≥azna znanego jako ÑPstryczekî. Orygina≥";
	TEXT[2]						=	"znaleziono schowany pod pod≥ogπ w starej komnacie.";
};
...
instance ItWr_BookXp_39a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(39, "Era bez snÛw", 1);
...
instance ItWr_BookXp_39b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(39, "Era bez snÛw", 2);
	TEXT[0]						=	"Fragmenty dziennika alchemika";
	TEXT[1]						=	"Wernarda z Farrin, odnalezione";
	TEXT[2]						=	"w zrujnowanej wieøy badawczej.";
};
...
instance ItWr_BookXp_40a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(40, "Na ≥aÒcuchu wolnoúci", 1);
...
instance ItWr_BookXp_40b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(40, "Na ≥aÒcuchu wolnoúci", 2);
	TEXT[0]						=	"Fragment osobistego dziennika niewolnika";
	TEXT[1]						=	"wyzwolonego dekretem cesarskim.";
	TEXT[2]						=	"Autor nieznany z imienia.";
};
...
instance ItWr_BookXp_42a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(42, "Straø w cieniu g≥odu", 1);
...
instance ItWr_BookXp_42b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(42, "Straø w cieniu g≥odu", 2);
	TEXT[0]						=	"Fragmenty notatnika kapitana Werrana";
	TEXT[1]						=	"w czasie wielkiego g≥odu w Roku Ognia.";
	TEXT[2]						=	"Zapiski ujawniono dopiero po jego úmierci.";
};
...
instance ItWr_BookXp_44a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(44, "Cud narzÍdzi", 1);
...
instance ItWr_BookXp_44b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(44, "Cud narzÍdzi", 2);
	TEXT[0]						=	"Notatki wynalazcy Seldrana z Warsztatu";
	TEXT[1]						=	"PÛ≥nocnego KrÍgu, sporzπdzone";
	TEXT[2]						=	"w latach 9ñ14 po Trzecim Przesileniu.";
};
...
instance ItWr_BookXp_46a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(46, "Anomalnie g≥Íbinowe", 1);
...
instance ItWr_BookXp_46b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(46, "Anomalnie g≥Íbinowe", 2);
	TEXT[0]						=	"Zapisy mistrza Geolitha z KrÍgu";
	TEXT[1]						=	"KartografÛw, spisane podczas wyprawy";
	TEXT[2]						=	"do podziemnych warstw GÛr Starych.";
};
...
instance ItWr_BookXp_48a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(48, "Pod powierzchniπ", 1);
...
instance ItWr_BookXp_48b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(48, "Pod powierzchniπ", 2);
	TEXT[0]						=	"Zapiski mistrza Neromenesa, maga wody";
	TEXT[1]						=	"z klasztoru Adanosa na Archolos,";
	TEXT[2]						=	"rok 88 po Drugim Z≥πczeniu.";
};
...
instance ItWr_BookXp_50a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(50, "Flet z kana≥Ûw", 1);
...
instance ItWr_BookXp_50b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(50, "Flet z kana≥Ûw", 2);
	TEXT[0]						=	"Sprawozdanie spisane przez kartografa";
	TEXT[1]						=	"i historyka Trymonesa";
	TEXT[2]						=	"z ramienia Straøy Archiwalnej.";
};
...
instance ItWr_BookXp_51a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(51, "CieÒ w úwietle", 1);
...
instance ItWr_BookXp_51b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(51, "CieÒ w úwietle", 2);
	TEXT[0]						=	"Zapiski mistrza Aronthela z Akademii åwiat≥a,";
	TEXT[1]						=	"spisane po odnalezieniu zw≥ok mrocznego";
	TEXT[2]						=	"czarnoksiÍønika w ruinach KalíAzar.";
};
...
instance ItWr_BookXp_52a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(52, "Kaplice bez bogÛw", 1);
...
instance ItWr_BookXp_52b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(52, "Kaplice bez bogÛw", 2);
	TEXT[0]						=	"Zapiski mistrza Eronthala z Gildii Wiedzy,";
	TEXT[1]						=	"spisane podczas badaÒ ruin";
	TEXT[2]						=	"wschodniego wybrzeøa.";
};
...
instance ItWr_BookXp_53a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(53, "Niewidzialne wiÍzy", 1);
...
instance ItWr_BookXp_53b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(53, "Niewidzialne wiÍzy", 2);
	TEXT[0]						=	"Notatki mistrza Iscarniona z Wieøy Syntezy,";
	TEXT[1]						=	"sporzπdzone po analizie przypadkÛw";
	TEXT[2]						=	"spontanicznych powiπzaÒ duchowych.";
};
...
instance ItWr_BookXp_54a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(54, "Domena snÛw", 1);
...
instance ItWr_BookXp_54b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(54, "Domena snÛw", 2);
	TEXT[0]						=	"Zapiski mistrza Aeremona z Komnaty Snu przy";
	TEXT[1]						=	"Wieøy Ciszy, prowadzone przez siedem lat";
	TEXT[2]						=	"eksperymentÛw i obserwacji.";
};
...
instance ItWr_BookXp_60a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(60, "Z Doliny SzeptÛw", 1);
...
instance ItWr_BookXp_60b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(60, "Z Doliny SzeptÛw", 2);
	TEXT[0]						=	"Praca badawcza mistrza Garinosa z Archiwum";
	TEXT[1]						=	"WewnÍtrznego Bractwa Wiedzy w Geldern,";
	TEXT[2]						=	"rok 76 po Drugim Z≥πczeniu.";
};
...
instance ItWr_BookXp_61a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(61, "Zapomniany krÛl", 1);
...
instance ItWr_BookXp_61b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(61, "Zapomniany krÛl", 2);
	TEXT[0]						=	"Notatki badawcze Elratha";
	TEXT[1]						=	"z Izby PamiÍci w Setarrif.";
	TEXT[2]						=	"Rok 118 po Drugim Z≥πczeniu.";
};
...
instance ItWr_BookXp_63a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(63, "Mowa bez s≥Ûw", 1);
...
instance ItWr_BookXp_63b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(63, "Mowa bez s≥Ûw", 2);
	TEXT[0]						=	"Spisane przez starego oberøystÍ";
	TEXT[1]						=	"z po≥udniowej marchii, na marginesie";
	TEXT[2]						=	"rachmistrzowego pergaminu. Rok nieznany.";
};
...
instance ItWr_BookXp_64a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(64, "Targi przed úwitem", 1);
...
instance ItWr_BookXp_64b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(64, "Targi przed úwitem", 2);
	TEXT[0]						=	"Spisane przez obserwatora miejskiego";
	TEXT[1]						=	"handlu w Setarrif, nieoficjalnie,";
	TEXT[2]						=	"na pergaminach ksiπg podatkowych.";
};
...
instance ItWr_BookXp_65a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(65, "Niedüwiedü z prze≥Íczy", 1);
...
instance ItWr_BookXp_65b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(65, "Niedüwiedü z prze≥Íczy", 2);
	TEXT[0]						=	"Spisana przez skalnego skrybÍ Yorrika";
	TEXT[1]						=	"z klanu M≥ota, w szeúÊdziesiπtπ zimÍ";
	TEXT[2]						=	"po bitwie o PrÛg Krwi.";
};
...
instance ItWr_BookXp_68a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(68, "åwiÍta bez czci", 1);
...
instance ItWr_BookXp_68b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(68, "åwiÍta bez czci", 2);
	TEXT[0]						=	"Notatki kap≥ana Emdora z klasztoru Dagnor,";
	TEXT[1]						=	"nieprzeznaczone do publikacji.";
	TEXT[2]						=	"Odnalezione po jego znikniÍciu.";
};
...
instance ItWr_BookXp_73a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(73, "WúrÛd cieniostworÛw", 1);
...
instance ItWr_BookXp_73b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(73, "WúrÛd cieniostworÛw", 2);
	TEXT[0]						=	"Spisane przez Werrana,";
	TEXT[1]						=	"myúliwego z GÛrskiego KrÍgu,";
	TEXT[2]						=	"w roku 42 po Wojnie SmokÛw.";
};
...
instance ItWr_BookXp_74a (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(74, "Upadek Z≥otego Liúcia", 1);
...
instance ItWr_BookXp_74b (ItemPR_BookXp)
{
	...
	description					=	BookXp_Description(74, "Upadek Z≥otego Liúcia", 2);
	TEXT[0]						=	"Spisane przez Malviana,";
	TEXT[1]						=	"archiwistÍ klasztoru Innosa w Khorinis,";
	TEXT[2]						=	"rok 49 po Wojnie SmokÛw.";
};
