...
const int oCItemContainer__GetSelectedItem 	= 7377600; 	// 0x007092C0	
...
const int oCNpc__EV_RemoveWeapon1_Len					= 7; // 0x07
const int oCNpc__EV_RemoveWeapon2_Len                	= 6; // 0x06
const int oCNpc__EV_RemoveWeapon_Len                	= 7; // 0x07
const int oCNpc__EV_DrawWeapon2_Len 					= 6; // 0x06
const int oCNpc__EV_DrawWeapon1_Len 					= 5; // 0x05
const int oCNpc__EV_DrawWeapon_Len 						= 6; // 0x06
...
const int oCNpcInventory__HandleEvent	 		= 7397440; // 0x0070E040
const int oCAIHuman__PC_WeaponMove				= 6922464; // 0x0069A0E0
const int oCNpc__EV_RemoveWeapon2				= 7661104; // 0x0074E630
const int oCNpc__EV_DrawWeapon2					= 7656832; // 0x0074D580
