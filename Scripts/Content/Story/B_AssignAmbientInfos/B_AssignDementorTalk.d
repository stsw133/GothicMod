...
func void DIA_AmbientDementor_Info()
{
	...
	else if (CurrentLevel == DRAGONISLAND_ZEN)
	{
		...
		{
			if (randy == 0)	{	AI_Output (self, other, "DIA_AmbientDementor_19_03");	};	//I tak dotar³eœ zbyt daleko, nêdzny robaku. Nigdy nie zst¹pisz do œwiêtego sanktuarium.
			if (randy == 1)	{	AI_Output (self, other, "DIA_AmbientDementor_19_04");	};	//Stój! Ani kroku dalej!
			if (randy == 2)	{	AI_Output (self, other, "DIA_AmbientDementor_19_05");	};	//Daleko zaszed³eœ, ale to ju¿ koniec twojej drogi.
			if (randy == 3)	{	AI_Output (self, other, "DIA_AmbientDementor_19_06");	};	//Jeœli chcesz zmierzyæ siê z moim Panem, musisz najpierw mnie pokonaæ!
		};
	}
	else if (hero.guild == GIL_KDF)
	{
		if (randy == 0)	{	AI_Output (self, other, "DIA_AmbientDementor_19_07");	};	//Nêdzna namiastko maga, nigdy nie sprostasz boskiej mocy mego Pana i Mistrza!
		if (randy == 1)	{	AI_Output (self, other, "DIA_AmbientDementor_19_08");	};	//A wiêc wybra³eœ œcie¿kê magii, by nas pokonaæ? Sprytny ruch, ale nawet to ciê teraz nie uratuje.
		if (randy == 2)	{	AI_Output (self, other, "DIA_AmbientDementor_19_09");	};	//Nawet jako mag nie zdo³asz nas zniszczyæ.
		if (randy == 3)	{	AI_Output (self, other, "DIA_AmbientDementor_19_10");	};	//Mój Pan pozbawi ciê ¿ycia. Twoje kuglarskie sztuczki w niczym ci nie pomog¹.
	}
	else
	{
		if (randy == 0)	{	AI_Output (self, other, "DIA_AmbientDementor_19_11");	};	//Poddaj siê, póki jeszcze mo¿esz. St¹d nie ma ucieczki.
		if (randy == 1)	{	AI_Output (self, other, "DIA_AmbientDementor_19_12");	};	//Teraz poznasz prawdziw¹ moc mego Pana. Nic ciê ju¿ nie uratuje!
		if (randy == 2)	{	AI_Output (self, other, "DIA_AmbientDementor_19_13");	};	//Mój Pan domaga siê twojej g³owy. Nie ma ju¿ dla ciebie ratunku.
		if (randy == 3)	{	AI_Output (self, other, "DIA_AmbientDementor_19_14");	};	//Wpad³eœ w nasze sid³a. Po¿egnaj siê z ¿yciem.
	};
...
func void B_AssignDementorTalk_Ritual()
{
	...
	else
	{
		...
		if (randy == 1)	{	AI_Output (self, other, "DIA_RitualDementor_19_04");	};	//Za Pana Ciemnoœci!
