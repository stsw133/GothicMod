...
func void B_GiveDeathInv (var C_Npc slf)
{
	...
	if (slf.aivar[AIV_MM_REAL_ID] == ID_TREANT)
	{
		...
		CreateInvItems (slf, ItMi_Firewood		, Hlp_Random(2));
	...
	if (PLAYER_TALENT_HUNTING[HUNTING_Blood])
	{
		...
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItem (slf, ItAt_BearBlood);				}
	...
	if (PLAYER_TALENT_HUNTING[HUNTING_Claws])
	{
		...
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_TIGER)					{	CreateInvItems (slf, ItAt_Claw				, 4);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BLOODHOUND)			{	CreateInvItems (slf, ItAt_Claw				, 4);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItems (slf, ItAt_Claw				, 4);	}
	...
	/// ------ Fat ------
	if (PLAYER_TALENT_HUNTING[HUNTING_Fat])
	{
		if		(slf.aivar[AIV_MM_REAL_ID] == ID_MOLERAT)				{	CreateInvItems (slf, ItAt_MoleratLubric		, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItems (slf, ItAt_BearFat			, 1);	};
	};
	
	/// ------ Feathers ------
	if		(slf.aivar[AIV_MM_REAL_ID] == ID_HARPY)						{	CreateInvItems (slf, ItAt_HarpyFeathers		, 3);	}
	else if	(slf.aivar[AIV_MM_REAL_ID] == ID_VAMPHARPY)					{	CreateInvItems (slf, ItAt_HarpyFeathers		, 4);	}
	else if	(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGONHARPY)				{	CreateInvItems (slf, ItAt_HarpyFeathers		, 5);	};
	...
	if (PLAYER_TALENT_HUNTING[HUNTING_Furs])
	{
		...
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItems (slf, ItAt_BearFur			, 1);	}
	...
	else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)						{	CreateInvItems (slf, ItFo_BadMeatRaw		, 2);	}
	...
	if (PLAYER_TALENT_HUNTING[HUNTING_Teeth])
	{
		...
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItems (slf, ItAt_Teeth				, 2);	}
	...
	/// ------ Tendons ------
	if (PLAYER_TALENT_HUNTING[HUNTING_Tendons])
	{
		if		(slf.aivar[AIV_MM_REAL_ID] == ID_SCAVENGER)				{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_JACKAL)				{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_WOLF)					{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_ICEWOLF)				{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_WARG)					{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_KEILER)				{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_TIGER)					{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BLOODHOUND)			{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_BEAR)					{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_SHADOWBEAST)			{	CreateInvItems (slf, ItAt_Tendons			, 3);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_TROLL)					{	CreateInvItems (slf, ItAt_Tendons			, 4);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_TROLL_BLACK)			{	CreateInvItems (slf, ItAt_Tendons			, 4);	}
		
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_WARAN)					{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_FIREWARAN)				{	CreateInvItems (slf, ItAt_Tendons			, 1);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_ALLIGATOR)				{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_SNAPPER)				{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_RAZOR)					{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_DRAGONSNAPPER)			{	CreateInvItems (slf, ItAt_Tendons			, 2);	}
		else if	(slf.aivar[AIV_MM_REAL_ID] == ID_GIANTSNAPPER)			{	CreateInvItems (slf, ItAt_Tendons			, 3);	};
	};
