...
func int DIA_Addon_Cavalorn_Beutel_Condition ()
{
	...
	&& ((Npc_HasItems (other,ItSe_CavalornsBeutel))||(SC_OpenedCavalornsBeutel == TRUE))
		{
			return TRUE;
		};
};
...
func int DIA_Addon_Cavalorn_ErzGeben_Condition ()
{
	...
	&& ((Npc_HasItems (other,ItSe_CavalornsBeutel))||(Npc_HasItems (other,ItMi_Nugget)))
		{
			return TRUE;
		};
};
...
func void DIA_Addon_Cavalorn_ErzGeben_Info ()
{
	...
	if (B_GiveInvItems (other, self, ItSe_CavalornsBeutel,1) == FALSE)
		{
