...
FUNC VOID DIA_Harad_Erzklingen_2h()
{
	...
	if (Npc_HasItems (other,ItMi_Gold) >= ItMw_2H_Blessed_01.value)
	{
		B_GiveInvItems (other,self,ItMi_Gold,ItMw_2H_Blessed_01.value);
...
FUNC VOID DIA_Harad_Erzklingen_1h()
{
	...
	if (Npc_HasItems (other,ItMi_Gold) >= ItMw_1H_Blessed_01.value)
	{
		B_GiveInvItems (other,self,ItMi_Gold,ItMw_1H_Blessed_01.value);
