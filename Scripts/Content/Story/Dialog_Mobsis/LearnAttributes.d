...
func void PC_LearnAttributes_TEACH_HP_Info()
{
	...
	Info_AddChoice (PC_LearnAttributes_TEACH_HP, B_BuildLearnString(ConcatStrings(PRINT_LearnHP, IntToString(20*HP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_HITPOINTS_MAX, 20), false), PC_LearnAttributes_TEACH_HP_20);
	Info_AddChoice (PC_LearnAttributes_TEACH_HP, B_BuildLearnString(ConcatStrings(PRINT_LearnHP, IntToString(10*HP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_HITPOINTS_MAX, 10), false), PC_LearnAttributes_TEACH_HP_10);
	Info_AddChoice (PC_LearnAttributes_TEACH_HP, B_BuildLearnString(ConcatStrings(PRINT_LearnHP, IntToString(5*HP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_HITPOINTS_MAX, 5), false), PC_LearnAttributes_TEACH_HP_5);
	Info_AddChoice (PC_LearnAttributes_TEACH_HP, B_BuildLearnString(ConcatStrings(PRINT_LearnHP, IntToString(1*HP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_HITPOINTS_MAX, 1), false), PC_LearnAttributes_TEACH_HP_1);
};
...
func void PC_LearnAttributes_TEACH_MP_Info()
{
	...
	Info_AddChoice (PC_LearnAttributes_TEACH_MP, B_BuildLearnString(ConcatStrings(PRINT_LearnMP, IntToString(20*MP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_MANA_MAX, 20), false), PC_LearnAttributes_TEACH_MP_20);
	Info_AddChoice (PC_LearnAttributes_TEACH_MP, B_BuildLearnString(ConcatStrings(PRINT_LearnMP, IntToString(10*MP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_MANA_MAX, 10), false), PC_LearnAttributes_TEACH_MP_10);
	Info_AddChoice (PC_LearnAttributes_TEACH_MP, B_BuildLearnString(ConcatStrings(PRINT_LearnMP, IntToString(5*MP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_MANA_MAX, 5), false), PC_LearnAttributes_TEACH_MP_5);
	Info_AddChoice (PC_LearnAttributes_TEACH_MP, B_BuildLearnString(ConcatStrings(PRINT_LearnMP, IntToString(1*MP_PER_LP)), B_GetLearnCostAttribute(hero, ATR_MANA_MAX, 1), false), PC_LearnAttributes_TEACH_MP_1);
};
...
func void PC_LearnAttributes_TEACH_SP_Info()
{
	...
	Info_AddChoice (PC_LearnAttributes_TEACH_SP, B_BuildLearnString(ConcatStrings(PRINT_LearnSP, IntToString(20*SP_PER_LP)), B_GetLearnCostAttribute(hero, AIV_STAMINA_MAX, 20), false), PC_LearnAttributes_TEACH_SP_20);
	Info_AddChoice (PC_LearnAttributes_TEACH_SP, B_BuildLearnString(ConcatStrings(PRINT_LearnSP, IntToString(10*SP_PER_LP)), B_GetLearnCostAttribute(hero, AIV_STAMINA_MAX, 10), false), PC_LearnAttributes_TEACH_SP_10);
	Info_AddChoice (PC_LearnAttributes_TEACH_SP, B_BuildLearnString(ConcatStrings(PRINT_LearnSP, IntToString(5*SP_PER_LP)), B_GetLearnCostAttribute(hero, AIV_STAMINA_MAX, 5), false), PC_LearnAttributes_TEACH_SP_5);
	Info_AddChoice (PC_LearnAttributes_TEACH_SP, B_BuildLearnString(ConcatStrings(PRINT_LearnSP, IntToString(1*SP_PER_LP)), B_GetLearnCostAttribute(hero, AIV_STAMINA_MAX, 1), false), PC_LearnAttributes_TEACH_SP_1);
};
