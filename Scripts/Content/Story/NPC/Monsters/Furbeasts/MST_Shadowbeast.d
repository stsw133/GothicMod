...
func void B_SetVisuals_Shadowbeast()
{
	...
	Mdl_SetVisualBody	(self, "Sha_Body", self.aivar[AIV_BodyTex], default, "", default, default, -1);
};
func void B_SetVisuals_Desertbeast()
{
	Mdl_SetVisual		(self, "Shadow.mds");
	Mdl_SetVisualBody	(self, "Sha_Desert_Body", self.aivar[AIV_BodyTex], default, "", default, default, -1);
};
