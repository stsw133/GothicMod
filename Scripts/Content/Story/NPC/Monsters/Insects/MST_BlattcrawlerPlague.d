...
///******************************************************************************************
func void B_SetVisuals_BlattcrawlerPlague()
{
	Mdl_SetVisual		(self, "Blattcrawler.mds");
	Mdl_SetVisualBody	(self, "Crw_Plague_Body", self.aivar[AIV_BodyTex], default, "", default, default, -1);
};
///******************************************************************************************
instance Plaguecrawler (Mst_Default_BlattcrawlerPlague)
{
	B_SetVisuals_BlattcrawlerPlague();
};
