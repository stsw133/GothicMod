...
FUNC VOID STARTUP_ADDON_PART_PIRATESCAMP_01 ()
{
	...
	Wld_InsertItem (ItAt_SkeletonSkull,"FP_ITEMSPAWN_SHALLOWWATER_13");	
...
//--------------------------------------------------------------------------	
	...
	*/
	...
	// Gebiet um Stonehenge
   	...
   	Wld_InsertNpc		(Skeleton_Mage_Angar,"OW_UNDEAD_DUNGEON_03"); //Joly: in der Höhle
...
func void STARTUP_NewWorld_Part_Farm_01()
{
	...
	Wld_InsertRandomStoneplate ("FP_ITEM_HERB_11");
...
//Jägerlager
	...
	Wld_InsertRandomStoneplate ("FP_NW_ITEM_BIGFARMFORESTCAVE_EGG");
...
FUNC VOID STARTUP_NewWorld_Part_Forest_01 ()
{
	...
	Wld_InsertNpc 	(Gobbo, "NW_CITY_TO_FOREST_15"); //FPs fehlen
...
FUNC VOID STARTUP_NewWorld_Part_TrollArea_01 ()
{
	...
	*/
	...
	Wld_InsertNpc 	(MinecrawlerWarrior, 	"NW_MAGECAVE_27");
	Wld_InsertRandomStoneplate ("FP_NW_ITEM_MAGECAVE_EGG");
...
{	
	...
	Kapitel = 7; //Joly: Kann hier stehen bleiben!
	if (!movieMode)
	{
		PlayVideo ("INTRO.BIK");
