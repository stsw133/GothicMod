...
const string NAME_SPL_Transform				=	"Przemiana";				/// 48	SPL_Transform
const string NAME_SPL_Summon				=	"Przyzwanie";

const string NAME_SPL_Charm					=	"Amnezja";					/// 59	SPL_Charm
...
const string TXT_TALENTS[NPC_TALENT_MAX] =
{
	...
	"D³ugi bieg:",				/// NPC_TALENT_LONGRUN			= 18;
	"Rozdzia³:",				/// NPC_TALENT_CHAPTER			= 19;
	"Typ magii:",				/// NPC_TALENT_TYPEOFMAGIC		= 20;
...
const string TXT_TALENTS_SKILLS[NPC_TALENT_MAX] =
{
	...
	"-|mistycyzm|geomancja|elementaryzm|pyromancja|nekromancja|inny",	/// NPC_TALENT_TYPEOFMAGIC	= 20;
