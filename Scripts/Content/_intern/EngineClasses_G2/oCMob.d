...
class oCMobInter
{
	...
	//oCMobInter:
	// The optimal positions are probably the ones the hero pops into when using the item. However, I'm not an animator and don't know much about it.
	...
	var int state_target;                   //int - The state that is currently being "worked towards"?
	...
	var int bitfield;                       /// see above
	var int tmpStateChanged;                //zBOOL
	
	var int Direction;                      //TMobInterDirection "Direction in which the mob is used????", (0 = none, 1 = up, 2 = down)
...
class oCMobContainer
{
	...
	//oCMobContainer
	var string contains;                //zSTRING //Script instances of the items. Not kept up to date! Original spacer settings!
