...
/// Sky controller
///******************************************************************************************
class zCSkyController_Outdoor /* oCSkyControler_Barrier */
{
	//zCObject {
	var int _vtbl;
	...
	/// a time-of-day-dependent lookup table for light values is provided.
	var int polyLightCLUTPtr;   //zCOLOR*  "colour look up table", see below
	...
	/// Screen Poly? For apertures? That's what the camera is for...
	...
	var int polyLightCLUT[256];     //zCOLOR // Color chart for lighting. Depending on the time of day
	...
	*/
	...
	/// wind
	var int m_bIsMainControler;   //zBOOL
	...
	var int rainFX_m_iRainCtr;                      //int - number of previous rainy seasons.
	//} rainFX;
