...
instance MENU_STATUS (C_MENU_DEF)
{
	...
	items[1] = "MENU_ITEM_CHAPTER";
	items[2] = "MENU_ITEM_PLAYERGUILD";
	items[3] = "MENU_ITEM_LEVEL_TITLE";
	items[4] = "MENU_ITEM_LEVEL";
	items[5] = "MENU_ITEM_EXP_TITLE";
	items[6] = "MENU_ITEM_EXP";
	items[7] = "MENU_ITEM_LEVEL_NEXT_TITLE";
	items[8] = "MENU_ITEM_LEVEL_NEXT";
	items[9] = "MENU_ITEM_LEARN_TITLE";
	items[10] = "MENU_ITEM_LEARN";
	items[11] = "MENU_ITEM_ATTRIBUTE_HEADING";
	items[12] = "MENU_ITEM_ATTRIBUTE_1_TITLE";
	items[13] = "MENU_ITEM_ATTRIBUTE_1";
	items[14] = "MENU_ITEM_ATTRIBUTE_2_TITLE";
	items[15] = "MENU_ITEM_ATTRIBUTE_2";
	items[16] = "MENU_ITEM_ATTRIBUTE_3_TITLE";
	items[17] = "MENU_ITEM_ATTRIBUTE_3";
	items[18] = "MENU_ITEM_ATTRIBUTE_4_TITLE";
	items[19] = "MENU_ITEM_ATTRIBUTE_4";
	items[20] = "MENU_ITEM_ATTRIBUTE_5_TITLE";
	items[21] = "MENU_ITEM_ATTRIBUTE_5";
	items[22] = "MENU_ITEM_ARMOR_HEADING";
	items[23] = "MENU_ITEM_ARMOR_1_TITLE";
	items[24] = "MENU_ITEM_ARMOR_1";
	items[25] = "MENU_ITEM_ARMOR_2_TITLE";
	items[26] = "MENU_ITEM_ARMOR_2";
	items[27] = "MENU_ITEM_ARMOR_3_TITLE";
	items[28] = "MENU_ITEM_ARMOR_3";
	items[29] = "MENU_ITEM_ARMOR_4_TITLE";
	items[30] = "MENU_ITEM_ARMOR_4";
	items[31] = "MENU_ITEM_ARMOR_5_TITLE";
	items[32] = "MENU_ITEM_ARMOR_5";
	...
	items[48] = "MENU_ITEM_TALENT_6_TITLE";
	items[49] = "MENU_ITEM_TALENT_6_SKILL";
	items[50] = "MENU_ITEM_TALENT_7_TITLE";
	items[51] = "MENU_ITEM_TALENT_7_SKILL";
	//items[52] = "MENU_ITEM_TALENT_8_TITLE";
	//items[53] = "MENU_ITEM_TALENT_8_SKILL";
	...
	items[56] = "MENU_ITEM_TALENT_12_TITLE";
	items[57] = "MENU_ITEM_TALENT_12_SKILL";
	items[58] = "MENU_ITEM_TALENT_13_TITLE";
	items[59] = "MENU_ITEM_TALENT_13_SKILL";
	items[60] = "MENU_ITEM_TALENT_14_TITLE";
	items[61] = "MENU_ITEM_TALENT_14_SKILL";
	items[62] = "MENU_ITEM_TALENT_15_TITLE";
	items[63] = "MENU_ITEM_TALENT_15_SKILL";
	items[64] = "MENU_ITEM_TALENT_16_TITLE";
	items[65] = "MENU_ITEM_TALENT_16_SKILL";
	items[66] = "MENU_ITEM_TALENT_17_TITLE";
	items[67] = "MENU_ITEM_TALENT_17_SKILL";
	items[68] = "MENU_ITEM_TALENT_18_TITLE";
	items[69] = "MENU_ITEM_TALENT_18_SKILL";
	items[70] = "MENU_ITEM_TALENT_19_TITLE";
	items[71] = "MENU_ITEM_TALENT_19_SKILL";
	items[72] = "MENU_ITEM_TALENT_20_TITLE";
	items[73] = "MENU_ITEM_TALENT_20_SKILL";
	items[74] = "MENU_ITEM_TALENT_21_TITLE";
	items[75] = "MENU_ITEM_TALENT_21_SKILL";
...
const int STAT_ATRHEAD_Y = 3350;
const int STAT_ATR_Y = 3800;
const int STAT_ARMHEAD_Y = 5600;
const int STAT_ARM_Y = 6050;
...
instance MENU_ITEM_CHAPTER (C_MENU_ITEM_DEF)	/// chapter
{
	posx = STAT_A_X1;
...
{
	posx = STAT_A_X1;
	posy = STAT_PLY_Y + (STAT_DY * 2) + STAT_DSY;
	text[0] = "Poz. postaci:";
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
instance MENU_ITEM_ATTRIBUTE_3_TITLE (C_MENU_ITEM_DEF)	/// mp
{
	posx = STAT_A_X1;
...
instance MENU_ITEM_ATTRIBUTE_5_TITLE (C_MENU_ITEM_DEF)	/// pow
{
	posx = STAT_A_X1;
...
instance MENU_ITEM_ARMOR_1_TITLE (C_MENU_ITEM_DEF)	/// blunt
{
	posx = STAT_A_X1;
...
instance MENU_ITEM_ARMOR_5_TITLE (C_MENU_ITEM_DEF)	/// edge
{
	posx = STAT_A_X1;
...
instance MENU_ITEM_TALENT_9_TITLE (C_MENU_ITEM_DEF)	/// dual wielding
{
	posx = STAT_B_X1;
...
instance MENU_ITEM_TALENT_10_TITLE (C_MENU_ITEM_DEF)	/// shield wielding
{
	posx = STAT_B_X1;
	posy = STAT_TAL_Y + (5 * STAT_DY + 0 * STAT_DSY);
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
instance MENU_ITEM_TALENT_21_TITLE (C_MENU_ITEM_DEF)	/// language
{
	posx = STAT_B_X1;
	posy = STAT_TAL_Y + (8 * STAT_DY + 1 * STAT_DSY);
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
instance MENU_ITEM_TALENT_20_TITLE (C_MENU_ITEM_DEF)	/// persuasion
{
	posx = STAT_B_X1;
	posy = STAT_TAL_Y + (11 * STAT_DY + 2 * STAT_DSY);
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
instance MENU_ITEM_TALENT_12_TITLE (C_MENU_ITEM_DEF)	/// fletchery
{
	posx = STAT_B_X1;
...
{
	posx = STAT_B_X1;
	posy = STAT_TAL_Y + (14 * STAT_DY + 3 * STAT_DSY);
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
{
	posx = STAT_B_X1;
	posy = STAT_TAL_Y + (15 * STAT_DY + 3 * STAT_DSY);
	fontname = STAT_FONT_DEFAULT;
	flags = flags & ~IT_SELECTABLE;
};
...
instance MENU_ITEM_TALENT_17_TITLE (C_MENU_ITEM_DEF)	/// cooking
{
	posx = STAT_B_X1;
...
instance MENU_ITEM_TALENT_18_TITLE (C_MENU_ITEM_DEF)	/// mining
{
	posx = STAT_B_X1;
...
instance MENU_ITEM_TALENT_19_TITLE (C_MENU_ITEM_DEF)	/// armory
{
	posx = STAT_B_X1;
