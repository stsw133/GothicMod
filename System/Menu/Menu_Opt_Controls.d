...
instance MENU_OPT_CONTROLS_EXTKEYS(C_MENU_DEF)
{
	...
	items[3] = "MENU_ITEM_KEY_SHORTCUTS";
	items[4] = "MENU_ITEM_INP_SHORTCUTS";
	items[5] = "MENU_ITEM_KEY_PICKPOCKET";
	items[6] = "MENU_ITEM_INP_PICKPOCKET";
...
//******************************************************************************************
instance MENU_ITEM_KEY_PICKPOCKET(C_MENU_ITEM_DEF)
{
	text[0] = "Kradzie¿ kiesz.";
	text[1] = "[Del] anuluje wybór, [Enter] zatwierdza nowy.";
	posx = CTRL_SP1_1;
	posy = CTRL_Y_START + (CTRL_Y_STEP * 2) + CTRL_GROUP1;
	onselaction[0] = SEL_ACTION_EXECCOMMANDS;
...
instance MENU_ITEM_INP_PICKPOCKET(C_MENU_ITEM_DEF)
{
	type = MENU_ITEM_INPUT;
	text[1] = "Wciœnij klawisz maj¹cy odpowiadaæ za dan¹ czynnoœæ.";
	posx = CTRL_SP1_2;
